...
class _TextFieldSearchState<T> extends State<TextFieldSearch<T>> {
  ...
  bool get isShowLogo => initialValue != null && (initialValue?.img != null || initialValue?.avatar != null);
            ...
            contentPadding: isShowLogo
                ? widget.contentPadding.add(
                    EdgeInsets.only(
                      ...
                      right: initialValue?.avatar != null ? avatarMarginRight : 0,
                    ),
                  )
                            ...
                            children: [
                              ...
                              if (e.avatar != null)
                                Padding(
                                  ...
                                  child: AvatarWidget(avatar: e.avatar, size: 28),
                                ),
                            ],
                          ),
                  ),
              ...
              child: ValueListenableBuilder<TextEditingValue>(
                  ...
                  builder: (_, valueText, __) {
                    ...
                    return InkWell(
                      ...
                      child: Icon(
                        hasClear ? Icons.clear : Icons.keyboard_arrow_down_rounded,
                        size: 20,
                        color: AppColors.grey10,
                      ),
                    );
