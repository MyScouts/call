...
import 'package:app_main/src/domain/usecases/ecom_usecase.dart';
...
typedef ListProductBloc
    = GetListBlocParam1<ProductDetailResponse, List<String>>;
...
abstract class MarshopBlocFactory {
  ...
  @factory
  ListProductBloc getProducts(EcomUsecase usecase) =>
      ListProductBloc(usecase.getProducts);
}
