...
class _UpdateKycPageState extends State<UpdateKycPage> {
  KycType _type = KycType.idNumber;
  ...
  bool get enableBtn => _type == KycType.idNumber
      ...
      child: BlocListener<UpgradePDoneBloc, UpgradePDoneState>(
        ...
        child: Column(
          children: [
            ...
            _buildDescription(_type.description(true)),
            _type == KycType.idNumber
                ? Column(
                    children: [
                      Padding(
                            ...
                            Expanded(
                              child: BlocBuilder<UpgradePDoneBloc,
                                ...
                                builder: (context, state) {
                                  const type = ImageKYCType.kycIdentityFront;
                                  ...
                                  return Stack(
                                    ...
                                    children: [
                                      ImageWithUploadButtonWidget(
                                        img:
                                            kycIdentityFront?.optimizeSize999 ??
                              ...
                              child: BlocBuilder<UpgradePDoneBloc,
                                ...
                                builder: (context, state) {
                                  ...
                                  return Stack(
                                    ...
                                    children: [
                                      ImageWithUploadButtonWidget(
                                        img: kycIdentityBack?.optimizeSize999 ??
                          ...
                          return Stack(
                            ...
                            children: [
                              UploadFrontFaceWidget(
                                ...
                                uploadedImg: portraitIdentity?.optimizeSize999,
                                onTap: () => onTapChooseImage(type),
                          ...
                          return Stack(
                            ...
                            children: [
                              ImageWithUploadButtonWidget(
                                ...
                                onTap: () => onTapChooseImage(type),
                                btnHeight: 39,
                                textBtn: 'Ảnh chụp trang thông tin hộ chiếu',
                                fontSizeBtn: 14,
                                imgHeight: 194,
                              ),
                              if (state is UploadKYCImageUploading &&
                          ...
                          return Stack(
                            ...
                            children: [
                              UploadFrontFaceWidget(
                                ...
                                uploadedImg: portraitPassport?.optimizeSize999,
                                onTap: () => onTapChooseImage(type),
                                textBtn: 'Chụp ảnh chân dung cầm thẻ hộ chiếu',
                              ),
                              if (state is UploadKYCImageUploading &&
                                  state.type == type)
                                _buildLoading()
  ...
  void _onTapVerify() {
    final payload = UpdatePDoneKYCPayload(
      kycPassport: _type == KycType.idNumber ? null : kycPassport,
      kycIdentityFront: _type == KycType.idNumber ? kycIdentityFront : null,
      kycIdentityBack: _type == KycType.idNumber ? kycIdentityBack : null,
      portrait:
          _type == KycType.idNumber ? portraitIdentity! : portraitPassport!,
    );
