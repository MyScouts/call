...
class _GroupsListingWidgetState extends State<GroupsListingWidget> with AutomaticKeepAliveClientMixin, SingleTickerProviderStateMixin {
  @override
  ...
  List<Group> groupsCommunity = [
    Group(banner: ImageConstants.communityLuatSu, name: 'Cộng đồng luật sư'),
    Group(banner: ImageConstants.communityXayDung, name: 'Cộng đồng kiến trúc'),
    Group(banner: ImageConstants.communityDuLich, name: 'Cộng đồng du lịch'),
    Group(banner: ImageConstants.communityViecLam, name: 'Cộng đồng việc làm'),
    Group(banner: ImageConstants.communityTruyenThong, name: 'Cộng đồng truyền thông'),
    Group(banner: ImageConstants.communityNgheThuat, name: 'Cộng đồng nghệ thuật'),
  ];
            ...
            child: Column(
              children: [
                Padding(
                  ...
                  child: ImageWidget(ImageConstants.communityBanner, width: width),
                ),
                const SizedBox(height: 20),
                CommunityTabBar(controller: _tabController),
                CommunityGroupWidget(groups: groupsCommunity),
                // Padding(
