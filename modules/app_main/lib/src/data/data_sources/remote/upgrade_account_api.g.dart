...
class _UpgradeAccountApi implements UpgradeAccountApi {
  ...
  @override
  Future<ApiResponse> updatePDoneProfileRange15To18({required payload}) async {
    // TODO: implement updatePDoneProfileRange15To18
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = payload;
    final _result = await _dio.fetch<Map<String, dynamic>>(
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              UpgradeAccountApiConstants.updatePDoneProfileTeenager,
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(
