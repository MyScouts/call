...
class _UpgradeAccountApi implements UpgradeAccountApi {
  ...
  Future<CheckExistIdentityNumber> checkExistIdentityNumber(
    ...
    final Map<String, dynamic>? _data = null;
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<CheckExistIdentityNumber>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = CheckExistIdentityNumber.fromJson(_result.data!);
    return value;
  }

  @override
  Future<PDoneEKycData> getEKycKey() async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final Map<String, dynamic>? _data = null;
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<PDoneEKycData>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = PDoneEKycData.fromJson(_result.data!);
    return value;
  }
