...
import 'package:mobilehub_bloc/mobilehub_bloc.dart' as _i68;
import 'package:shared_preferences/shared_preferences.dart' as _i17;

import '../app_delegate.dart' as _i4;
import '../blocs/auth/auth_cubit.dart' as _i91;
import '../blocs/marshop/marshop_cubit.dart' as _i83;
import '../blocs/user/user_cubit.dart' as _i89;
import '../blocs/user_action/user_action_cubit.dart' as _i87;
...
import '../data/data_sources/remote/auth_api.dart' as _i54;
import '../data/data_sources/remote/community_api.dart' as _i59;
...
import '../data/data_sources/remote/user_api.dart' as _i50;
...
import '../data/models/payloads/upgrade_account/upgrade_ja/verify_phone_otp.dart'
    as _i72;
import '../data/models/responses/boss_community_status_response.dart' as _i78;
import '../data/models/responses/confirm_register_ja_response.dart' as _i74;
import '../data/models/responses/confirm_response.dart' as _i77;
import '../data/models/responses/group_request_response.dart' as _i80;
import '../data/models/responses/ja_status_response.dart' as _i71;
import '../data/models/responses/upgrade_account_response.dart' as _i69;
import '../data/repositories/auth_repository.dart' as _i55;
import '../data/repositories/impl/auth_repository_impl.dart' as _i56;
import '../data/repositories/impl/community_repository.impl.dart' as _i61;
...
import '../data/repositories/impl/user_repository_impl.dart' as _i52;
import '../data/repositories/marshop_repository.dart' as _i25;
import '../data/repositories/notification_repository.dart' as _i29;
import '../data/repositories/user_repository.dart' as _i51;
import '../domain/entities/bank.dart' as _i81;
import '../domain/entities/commity_action_type.dart' as _i73;
import '../domain/entities/update_account/bank_acount/bank_account.dart'
    as _i70;
import '../domain/repository/community_repository.dart' as _i60;
...
import '../domain/usecases/authentication_usecase.dart' as _i57;
import '../domain/usecases/community_usecase.dart' as _i62;
...
import '../domain/usecases/user_usecase.dart' as _i53;
...
import '../presentation/shared/app_setting/bloc/app_setting_bloc.dart' as _i90;
import '../presentation/shared/user/bloc/user_bloc.dart' as _i88;
import '../presentation/social/profile/profile_bloc.dart' as _i95;
...
import '../presentation/upgrade_account/upgrade_pdone/bloc/upgrade_pdone/upgrade_pdone_bloc.dart'
    as _i49;
import 'modules/data_source_module.dart' as _i92;
...
Future<_i1.GetIt> init(
  ...
  gh.factory<_i41.ResourceApi>(() => _i41.ResourceApi(gh<_i23.Dio>()));
  ...
  gh.factory<_i48.UpgradeAccountUsecase>(() => _i48.UpgradeAccountUsecase(
        gh<_i46.UpgradeAccountRepository>(),
        gh<_i22.EKycViettel>(),
      ));
  gh.factory<_i49.UpgradePDoneBloc>(() => _i49.UpgradePDoneBloc(
        gh<_i48.UpgradeAccountUsecase>(),
        gh<_i44.ResourceUsecase>(),
        gh<_i20.UserSharePreferencesUsecase>(),
      ));
  gh.factory<_i50.UserApi>(() => _i50.UserApi(gh<_i3.Dio>()));
  gh.factory<_i51.UserRepository>(
      () => _i52.AuthRepositoryImpl(gh<_i50.UserApi>()));
  gh.factory<_i53.UserUsecase>(
      () => _i53.UserUsecase(gh<_i51.UserRepository>()));
  gh.factory<_i54.AuthApi>(() => _i54.AuthApi(gh<_i23.Dio>()));
  gh.factory<_i55.AuthRepository>(
      () => _i56.AuthRepositoryImpl(gh<_i54.AuthApi>()));
  gh.factory<_i57.AuthenticationUsecase>(() => _i57.AuthenticationUsecase(
        gh<_i55.AuthRepository>(),
        gh<_i20.UserSharePreferencesUsecase>(),
        gh<_i51.UserRepository>(),
      ));
  gh.factory<_i58.ChangePasswordController>(
      () => _i58.ChangePasswordController(gh<_i57.AuthenticationUsecase>()));
  gh.factory<_i59.CommunityApi>(() => _i59.CommunityApi(gh<_i3.Dio>()));
  gh.factory<_i60.CommunityRepository>(
      () => _i61.CommunityRepositoryImpl(gh<_i59.CommunityApi>()));
  gh.factory<_i62.CommunityUsecase>(() => _i62.CommunityUsecase(
        gh<_i60.CommunityRepository>(),
        gh<_i44.ResourceUsecase>(),
      ));
  gh.factory<_i63.DashBoardBgController>(() =>
      _i63.DashBoardBgController(gh<_i21.DashboardSharePreferenceUseCase>()));
  gh.factory<_i64.DashboardCommunityBloc>(() =>
      _i64.DashboardCommunityBloc(gh<_i21.DashboardSharePreferenceUseCase>()));
  gh.factory<_i64.DashboardEcommerceBloc>(() =>
      _i64.DashboardEcommerceBloc(gh<_i21.DashboardSharePreferenceUseCase>()));
  gh.factory<_i64.DashboardPersonalBloc>(() =>
      _i64.DashboardPersonalBloc(gh<_i21.DashboardSharePreferenceUseCase>()));
  gh.factoryParam<_i65.EditCommunityDetailBloc, _i3.Community, dynamic>((
    community,
    _,
  ) =>
      _i65.EditCommunityDetailBloc(
        gh<_i62.CommunityUsecase>(),
        community,
      ));
  gh.factoryParam<_i66.EditFanGroupBloc, _i3.FanGroup, dynamic>((
    fanGroup,
    _,
  ) =>
      _i66.EditFanGroupBloc(
        gh<_i62.CommunityUsecase>(),
        fanGroup,
      ));
  gh.factory<_i67.FanGroupDetailBloc>(
      () => _i67.FanGroupDetailBloc(gh<_i62.CommunityUsecase>()));
  gh.factory<_i68.GetDetailBloc<_i69.UpgradeAccountResponse>>(() =>
      upgradeAgreePolicyBlocFactory
          .createUpgradeAccountBloc(gh<_i48.UpgradeAccountUsecase>()));
  gh.factory<_i68.GetDetailBloc<_i3.FanGroup>>(
      () => communityModule.createGetFanGroupBloc(gh<_i62.CommunityUsecase>()));
  gh.factory<_i68.GetDetailBloc<_i70.BankAccount>>(() =>
      upgradeAgreePolicyBlocFactory
          .createGetDefaultBankBloc(gh<_i48.UpgradeAccountUsecase>()));
  gh.factory<_i68.GetDetailBloc<_i71.JAStatusResponse>>(() =>
      upgradeAgreePolicyBlocFactory
          .createGetJAStatusBloc(gh<_i48.UpgradeAccountUsecase>()));
  gh.factory<_i68.GetDetailBlocParam1<bool, _i72.VerifyPhoneOtpPayload>>(() =>
      upgradeAgreePolicyBlocFactory.createUpgradeAccountVerifyPhoneBloc(
          gh<_i48.UpgradeAccountUsecase>()));
  gh.factory<_i68.GetDetailBlocParam1<_i3.User?, int>>(
      () => diaryBlocFactory.getUserDetailBloc(gh<_i53.UserUsecase>()));
  gh.factory<
      _i68.GetDetailBlocParam1<_i69.UpgradeAccountResponse,
          _i73.PDoneActionType>>(() => upgradeAgreePolicyBlocFactory
      .createResendOTPPhoneBloc(gh<_i48.UpgradeAccountUsecase>()));
  gh.factory<
      _i68.GetDetailBlocParam1<_i74.ConfirmRegisterJAResponse,
          _i75.ConfirmRegisterJAPayload>>(() => upgradeAgreePolicyBlocFactory
      .createConfirmRegisterJABloc(gh<_i48.UpgradeAccountUsecase>()));
  gh.factory<
      _i68.GetDetailBlocParam1<_i70.BankAccount,
          _i76.UpdateBankAccountPayload>>(() => upgradeAgreePolicyBlocFactory
      .createUpdateBankAccountBloc(gh<_i48.UpgradeAccountUsecase>()));
  gh.factory<_i68.GetDetailBlocParam1<_i77.ConfirmResponse, String>>(() =>
      communityModule
          .createRelinquishBossGroupBloc(gh<_i62.CommunityUsecase>()));
  gh.factory<
          _i68.GetDetailBlocParam1<_i78.BossCommunityStatusResponse, String>>(
      () =>
          communityModule.createGetBossStatusBloc(gh<_i62.CommunityUsecase>()));
  gh.factory<
      _i68.GetDetailBlocParam2<_i77.ConfirmResponse, String,
          _i79.ReplyGiveUpBossTeamRolePayload>>(() => communityModule
      .createReplyGiveUpBossTeamBloc(gh<_i62.CommunityUsecase>()));
  gh.factory<_i68.GetListBloc<_i80.GroupRequest>>(() =>
      communityModule.createGetGroupRequestsBloc(gh<_i62.CommunityUsecase>()));
  gh.factory<_i68.GetListBloc<_i81.Bank>>(() => upgradeAgreePolicyBlocFactory
      .createGetListBanksBloc(gh<_i48.UpgradeAccountUsecase>()));
  gh.factory<_i68.GetListBloc<_i3.Group>>(() =>
      communityModule.createGetListGroupsBloc(gh<_i62.CommunityUsecase>()));
  gh.factory<_i68.GetListBlocParam1<_i3.Team, String>>(() =>
      communityModule.createGetListTeamsBloc(gh<_i62.CommunityUsecase>()));
  gh.factory<_i82.GroupDetailBloc>(
      () => _i82.GroupDetailBloc(gh<_i62.CommunityUsecase>()));
  gh.factory<_i83.MarshopCubit>(
      () => _i83.MarshopCubit(gh<_i27.MarshopUsecase>()));
  ...
  gh.factory<_i86.TeamDetailBloc>(
      () => _i86.TeamDetailBloc(gh<_i62.CommunityUsecase>()));
  gh.factory<_i87.UserActionCubit>(
      () => _i87.UserActionCubit(gh<_i53.UserUsecase>()));
  gh.factory<_i88.UserBloc>(() => _i88.UserBloc(
        gh<_i57.AuthenticationUsecase>(),
        gh<_i20.UserSharePreferencesUsecase>(),
        gh<_i53.UserUsecase>(),
        gh<_i3.UserInformationCubit>(),
      ));
  gh.factory<_i89.UserCubit>(() => _i89.UserCubit(
        gh<_i57.AuthenticationUsecase>(),
        gh<_i20.UserSharePreferencesUsecase>(),
        gh<_i53.UserUsecase>(),
      ));
  gh.singleton<_i90.AppSettingBloc>(
      _i90.AppSettingBloc(gh<_i57.AuthenticationUsecase>()));
  gh.factory<_i91.AuthCubit>(
      () => _i91.AuthCubit(gh<_i57.AuthenticationUsecase>()));
  return getIt;
}

class _$DataSourceModule extends _i92.DataSourceModule {}

class _$PlaceModule extends _i37.PlaceModule {}

class _$UpgradeAgreePolicyBlocFactory
    extends _i93.UpgradeAgreePolicyBlocFactory {}

class _$CommunityModule extends _i94.CommunityModule {}

class _$DiaryBlocFactory extends _i95.DiaryBlocFactory {}
