...
import 'package:mobilehub_bloc/mobilehub_bloc.dart' as _i95;
import 'package:shared_preferences/shared_preferences.dart' as _i28;
import 'package:wallet/core/core.dart' as _i32;
import 'package:wallet/di/wallet_micro.module.dart' as _i137;

import '../app_delegate.dart' as _i4;
import '../blocs/app/app_cubit.dart' as _i134;
import '../blocs/approved_request/approved_request_cubit.dart' as _i77;
import '../blocs/auth/auth_cubit.dart' as _i136;
import '../blocs/community/team_request/team_request_cubit.dart' as _i128;
import '../blocs/marshop/marshop_cubit.dart' as _i120;
import '../blocs/user/user_cubit.dart' as _i132;
import '../blocs/user_action/user_action_cubit.dart' as _i130;
...
import '../data/data_sources/local/information_pdone_profile/information_pdone_profile_local.dart'
    as _i35;
import '../data/data_sources/remote/auth_api.dart' as _i78;
import '../data/data_sources/remote/community_api.dart' as _i84;
...
import '../data/models/responses/boss_team_relinquish_status_response.dart'
    as _i101;
import '../data/models/responses/confirm_register_ja_response.dart' as _i102;
import '../data/models/responses/confirm_response.dart' as _i106;
import '../data/models/responses/group_request_response.dart' as _i110;
...
import '../data/repositories/auth_repository.dart' as _i79;
import '../data/repositories/impl/auth_repository_impl.dart' as _i80;
import '../data/repositories/impl/community_repository.impl.dart' as _i86;
...
import '../domain/entities/commity_action_type.dart' as _i105;
import '../domain/entities/update_account/bank_acount/bank_account.dart'
    as _i98;
import '../domain/repository/community_repository.dart' as _i85;
...
import '../domain/usecases/authentication_usecase.dart' as _i81;
import '../domain/usecases/community_usecase.dart' as _i87;
...
import '../presentation/community/community_module.dart' as _i141;
...
import '../presentation/community/team_detail/pages/add_team_member_sheet.dart'
    as _i76;
import '../presentation/dashboard/dashboard/dashboard_screen.dart' as _i89;
...
import '../presentation/dashboard/dashboard/widget/dashboard_background_builder.dart'
    as _i88;
import '../presentation/dashboard/dashboard_module.dart' as _i143;
...
import '../presentation/notification/state/notification_bloc.dart' as _i121;
import '../presentation/otp_verify/email_otp_verify.dart' as _i93;
import '../presentation/profile/state/user_profile_bloc.dart' as _i133;
...
import '../presentation/shared/app_setting/bloc/app_setting_bloc.dart' as _i135;
import '../presentation/shared/user/bloc/user_bloc.dart' as _i131;
import '../presentation/social/profile/profile_bloc.dart' as _i142;
...
import '../presentation/upgrade_account/upgrade_pdone/bloc/upgrade_pdone/upgrade_pdone_bloc.dart'
    as _i129;
import 'modules/config_module.dart' as _i139;
import 'modules/data_source_module.dart' as _i138;
...
Future<_i1.GetIt> init(
  ...
  gh.factory<_i77.ApprovedRequestCubit>(
      () => _i77.ApprovedRequestCubit(gh<_i75.UserUsecase>()));
  gh.factory<_i78.AuthApi>(() => _i78.AuthApi(gh<_i42.Dio>()));
  gh.factory<_i79.AuthRepository>(
      () => _i80.AuthRepositoryImpl(gh<_i78.AuthApi>()));
  gh.factory<_i81.AuthenticationUsecase>(() => _i81.AuthenticationUsecase(
        gh<_i79.AuthRepository>(),
        gh<_i31.UserSharePreferencesUsecase>(),
        gh<_i73.UserRepository>(),
        gh<_i23.NotificationService>(),
      ));
  gh.factory<_i82.CategoryController>(
      () => _i82.CategoryController(gh<_i38.LiveRepository>()));
  gh.factory<_i83.ChangePasswordController>(
      () => _i83.ChangePasswordController(gh<_i81.AuthenticationUsecase>()));
  gh.factory<_i84.CommunityApi>(() => _i84.CommunityApi(gh<_i3.Dio>()));
  gh.factory<_i85.CommunityRepository>(
      () => _i86.CommunityRepositoryImpl(gh<_i84.CommunityApi>()));
  gh.factory<_i87.CommunityUsecase>(() => _i87.CommunityUsecase(
        gh<_i85.CommunityRepository>(),
        gh<_i66.ResourceUsecase>(),
      ));
  gh.factory<_i88.DashBoardBgController>(() =>
      _i88.DashBoardBgController(gh<_i33.DashboardSharePreferenceUseCase>()));
  gh.lazySingleton<_i89.DashBoardScreenController>(() =>
      _i89.DashBoardScreenController(
          gh<_i33.DashboardSharePreferenceUseCase>()));
  gh.factory<_i90.DashboardCommunityBloc>(() =>
      _i90.DashboardCommunityBloc(gh<_i33.DashboardSharePreferenceUseCase>()));
  gh.factory<_i90.DashboardEcommerceBloc>(() =>
      _i90.DashboardEcommerceBloc(gh<_i33.DashboardSharePreferenceUseCase>()));
  gh.factory<_i90.DashboardPersonalBloc>(() =>
      _i90.DashboardPersonalBloc(gh<_i33.DashboardSharePreferenceUseCase>()));
  gh.factoryParam<_i91.EditCommunityDetailBloc, _i3.Community, dynamic>((
    community,
    _,
  ) =>
      _i91.EditCommunityDetailBloc(
        gh<_i87.CommunityUsecase>(),
        community,
      ));
  gh.factoryParam<_i92.EditFanGroupBloc, _i3.FanGroup, dynamic>((
    fanGroup,
    _,
  ) =>
      _i92.EditFanGroupBloc(
        gh<_i87.CommunityUsecase>(),
        fanGroup,
      ));
  gh.factory<_i93.EmailVerifyController>(
      () => _i93.EmailVerifyController(gh<_i75.UserUsecase>()));
  gh.factory<_i94.FanGroupDetailBloc>(
      () => _i94.FanGroupDetailBloc(gh<_i87.CommunityUsecase>()));
  gh.factory<_i95.GetDetailBloc<_i96.JAStatusResponse>>(() =>
      upgradeAgreePolicyBlocFactory
          .createGetJAStatusBloc(gh<_i70.UpgradeAccountUsecase>()));
  gh.factory<_i95.GetDetailBloc<_i97.UpgradeAccountResponse>>(() =>
      upgradeAgreePolicyBlocFactory
          .createUpgradeAccountBloc(gh<_i70.UpgradeAccountUsecase>()));
  gh.factory<_i95.GetDetailBloc<_i98.BankAccount>>(() =>
      upgradeAgreePolicyBlocFactory
          .createGetDefaultBankBloc(gh<_i70.UpgradeAccountUsecase>()));
  gh.factory<_i95.GetDetailBloc<_i3.FanGroup>>(
      () => communityModule.createGetFanGroupBloc(gh<_i87.CommunityUsecase>()));
  gh.factory<_i95.GetDetailBlocParam1<dynamic, _i99.VerifyPhoneOtpPayload>>(
      () => upgradeAgreePolicyBlocFactory.createUpgradeAccountVerifyPhoneBloc(
          gh<_i70.UpgradeAccountUsecase>()));
  gh.factory<
          _i95.GetDetailBlocParam1<_i100.BossCommunityStatusResponse, String>>(
      () =>
          communityModule.createGetBossStatusBloc(gh<_i87.CommunityUsecase>()));
  gh.factory<_i95.GetDetailBlocParam1<_i3.User?, int>>(
      () => diaryBlocFactory.getUserDetailBloc(gh<_i75.UserUsecase>()));
  gh.factory<
          _i95
          .GetDetailBlocParam1<_i101.BossTeamRelinquishStatusResponse, String>>(
      () => communityModule
          .createGetBossTeamRelinquishStatusBloc(gh<_i87.CommunityUsecase>()));
  gh.factory<
      _i95.GetDetailBlocParam1<_i102.ConfirmRegisterJAResponse,
          _i103.ConfirmRegisterJAPayload>>(() => upgradeAgreePolicyBlocFactory
      .createConfirmRegisterJABloc(gh<_i70.UpgradeAccountUsecase>()));
  gh.factory<
      _i95.GetDetailBlocParam1<_i98.BankAccount,
          _i104.UpdateBankAccountPayload>>(() => upgradeAgreePolicyBlocFactory
      .createUpdateBankAccountBloc(gh<_i70.UpgradeAccountUsecase>()));
  gh.factory<
      _i95.GetDetailBlocParam1<_i97.UpgradeAccountResponse,
          _i105.PDoneActionType>>(() => upgradeAgreePolicyBlocFactory
      .createResendOTPPhoneBloc(gh<_i70.UpgradeAccountUsecase>()));
  gh.factory<
      _i95.GetDetailBlocParam2<_i106.ConfirmResponse, String,
          _i107.CommunityType>>(() => communityModule
      .createRelinquishBossRoleBloc(gh<_i87.CommunityUsecase>()));
  gh.factory<
      _i95.GetDetailBlocParam2<_i106.ConfirmResponse, String,
          _i108.ReplyGiveUpBossTeamRolePayload>>(() => communityModule
      .createReplyGiveUpBossTeamBloc(gh<_i87.CommunityUsecase>()));
  gh.factory<_i95.GetListBloc<_i3.Group>>(() =>
      communityModule.createGetListGroupsBloc(gh<_i87.CommunityUsecase>()));
  gh.factory<_i95.GetListBloc<_i109.Bank>>(() => upgradeAgreePolicyBlocFactory
      .createGetListBanksBloc(gh<_i70.UpgradeAccountUsecase>()));
  gh.factory<_i95.GetListBloc<_i3.Team>>(
      () => dashBoardModule.getMyTeams(gh<_i87.CommunityUsecase>()));
  gh.factory<_i95.GetListBloc<_i110.GroupRequest>>(() =>
      communityModule.createGetGroupRequestsBloc(gh<_i87.CommunityUsecase>()));
  gh.factory<_i95.GetListBlocParam1<_i3.Team, String>>(() =>
      communityModule.createGetListTeamsBloc(gh<_i87.CommunityUsecase>()));
  gh.factory<_i111.GiftController>(
      () => _i111.GiftController(gh<_i40.LiveUseCase>()));
  gh.factory<_i112.GroupDetailBloc>(
      () => _i112.GroupDetailBloc(gh<_i87.CommunityUsecase>()));
  gh.factory<_i113.GuardianPDoneBloc>(
      () => _i113.GuardianPDoneBloc(gh<_i70.UpgradeAccountUsecase>()));
  gh.factory<_i114.InformationUpdateProfilBloc>(
      () => _i114.InformationUpdateProfilBloc(
            gh<_i75.UserUsecase>(),
            gh<_i35.InformationPDoneSharePreferencesUsecase>(),
          ));
  gh.factory<_i115.ListProtectorRequestController>(
      () => _i115.ListProtectorRequestController(gh<_i62.ProtectorUseCase>()));
  gh.factory<_i116.LiveBottomController>(() => _i116.LiveBottomController(
        gh<_i40.LiveUseCase>(),
        gh<_i75.UserUsecase>(),
      ));
  gh.factory<_i117.LiveChannelController>(() => _i117.LiveChannelController(
  ...
  gh.factory<_i118.LiveController>(
      () => _i118.LiveController(gh<_i40.LiveUseCase>()));
  gh.factory<_i119.LiveCreateController>(() => _i119.LiveCreateController(
        gh<_i38.LiveRepository>(),
        gh<_i15.LiveService>(),
      ));
  gh.factory<_i115.ManageProtectController>(
      () => _i115.ManageProtectController(gh<_i62.ProtectorUseCase>()));
  gh.factory<_i120.MarshopCubit>(
      () => _i120.MarshopCubit(gh<_i45.MarshopUsecase>()));
  gh.factory<_i121.NotificationBloc>(
      () => _i121.NotificationBloc(gh<_i49.NotificationUsecase>()));
  gh.factory<_i122.OpenWeatherBloc>(
      () => _i122.OpenWeatherBloc(gh<_i53.OpenWeatherUseCase>()));
  gh.factory<_i123.PDoneInformationBloc>(
      () => _i123.PDoneInformationBloc(gh<_i70.UpgradeAccountUsecase>()));
  gh.factory<_i124.PlaceInformationBloc>(
      () => _i124.PlaceInformationBloc(gh<_i58.PlaceInformationUsecase>()));
  gh.factory<_i125.PlaceInformationBloc2>(
      () => _i125.PlaceInformationBloc2(gh<_i58.PlaceInformationUsecase>()));
  gh.factory<_i126.SearchCubit>(
      () => _i126.SearchCubit(gh<_i75.UserUsecase>()));
  gh.factory<_i127.TeamDetailBloc>(
      () => _i127.TeamDetailBloc(gh<_i87.CommunityUsecase>()));
  gh.factory<_i128.TeamRequestCubit>(
      () => _i128.TeamRequestCubit(gh<_i87.CommunityUsecase>()));
  gh.factory<_i129.UpgradePDoneBloc>(() => _i129.UpgradePDoneBloc(
        gh<_i70.UpgradeAccountUsecase>(),
        gh<_i75.UserUsecase>(),
        gh<_i31.UserSharePreferencesUsecase>(),
      ));
  gh.factory<_i130.UserActionCubit>(
      () => _i130.UserActionCubit(gh<_i75.UserUsecase>()));
  gh.factory<_i131.UserBloc>(() => _i131.UserBloc(
        gh<_i81.AuthenticationUsecase>(),
        gh<_i31.UserSharePreferencesUsecase>(),
        gh<_i75.UserUsecase>(),
        gh<_i3.UserInformationCubit>(),
      ));
  gh.factory<_i132.UserCubit>(() => _i132.UserCubit(
        gh<_i81.AuthenticationUsecase>(),
        gh<_i31.UserSharePreferencesUsecase>(),
        gh<_i75.UserUsecase>(),
      ));
  ...
  gh.factory<_i134.AppCubit>(() => _i134.AppCubit(
        gh<_i66.ResourceUsecase>(),
        gh<_i31.UserSharePreferencesUsecase>(),
        gh<_i81.AuthenticationUsecase>(),
      ));
  gh.singleton<_i135.AppSettingBloc>(
      _i135.AppSettingBloc(gh<_i81.AuthenticationUsecase>()));
  gh.factory<_i136.AuthCubit>(
      () => _i136.AuthCubit(gh<_i81.AuthenticationUsecase>()));
  await _i137.WalletPackageModule().init(gh);
  return getIt;
}

class _$DataSourceModule extends _i138.DataSourceModule {}

class _$ConfigModule extends _i139.ConfigModule {}

class _$PlaceModule extends _i55.PlaceModule {}

class _$UpgradeAgreePolicyBlocFactory
    extends _i140.UpgradeAgreePolicyBlocFactory {}

class _$CommunityModule extends _i141.CommunityModule {}

class _$DiaryBlocFactory extends _i142.DiaryBlocFactory {}

class _$DashBoardModule extends _i143.DashBoardModule {}
