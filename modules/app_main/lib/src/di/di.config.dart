...
import '../blocs/auth/auth_cubit.dart' as _i108;
import '../blocs/community/team_request/team_request_cubit.dart' as _i102;
import '../blocs/marshop/marshop_cubit.dart' as _i95;
import '../blocs/user/user_cubit.dart' as _i106;
import '../blocs/user_action/user_action_cubit.dart' as _i104;
...
import '../presentation/shared/app_setting/bloc/app_setting_bloc.dart' as _i107;
import '../presentation/shared/user/bloc/user_bloc.dart' as _i105;
import '../presentation/social/profile/profile_bloc.dart' as _i112;
...
import '../presentation/upgrade_account/upgrade_pdone/bloc/upgrade_pdone/upgrade_pdone_bloc.dart'
    as _i103;
import 'modules/data_source_module.dart' as _i109;
...
Future<_i1.GetIt> init(
  ...
  gh.factory<
          _i75
          .GetDetailBlocParam1<_i79.BossTeamRelinquishStatusResponse, String>>(
      () => communityModule
  ...
  gh.factory<_i75.GetDetailBlocParam1<bool, _i83.VerifyPhoneOtpPayload>>(() =>
  ...
  gh.factory<_i98.PlaceInformationBloc>(
      () => _i98.PlaceInformationBloc(gh<_i43.PlaceInformationUsecase>()));
  gh.factory<_i99.PlaceInformationBloc2>(
      () => _i99.PlaceInformationBloc2(gh<_i43.PlaceInformationUsecase>()));
  gh.factory<_i100.SearchCubit>(
      () => _i100.SearchCubit(gh<_i59.UserUsecase>()));
  gh.factory<_i101.TeamDetailBloc>(
      () => _i101.TeamDetailBloc(gh<_i69.CommunityUsecase>()));
  gh.factory<_i102.TeamRequestCubit>(
      () => _i102.TeamRequestCubit(gh<_i69.CommunityUsecase>()));
  gh.factory<_i103.UpgradePDoneBloc>(() => _i103.UpgradePDoneBloc(
        gh<_i55.UpgradeAccountUsecase>(),
        gh<_i59.UserUsecase>(),
      ));
  gh.factory<_i104.UserActionCubit>(
      () => _i104.UserActionCubit(gh<_i59.UserUsecase>()));
  gh.factory<_i105.UserBloc>(() => _i105.UserBloc(
  ...
  gh.singleton<_i107.AppSettingBloc>(
      _i107.AppSettingBloc(gh<_i64.AuthenticationUsecase>()));
  gh.factory<_i108.AuthCubit>(
      () => _i108.AuthCubit(gh<_i64.AuthenticationUsecase>()));
  return getIt;
}

class _$DataSourceModule extends _i109.DataSourceModule {}

class _$PlaceModule extends _i40.PlaceModule {}

class _$UpgradeAgreePolicyBlocFactory
    extends _i110.UpgradeAgreePolicyBlocFactory {}

class _$CommunityModule extends _i111.CommunityModule {}

class _$DiaryBlocFactory extends _i112.DiaryBlocFactory {}
