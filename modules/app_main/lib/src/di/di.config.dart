...
import '../presentation/community/community_module.dart' as _i93;
...
Future<_i1.GetIt> init(
  ...
  gh.factory<_i81.MarshopCubit>(
      () => _i81.MarshopCubit(gh<_i26.MarshopUsecase>()));
  gh.factory<_i82.OpenWeatherBloc>(
      () => _i82.OpenWeatherBloc(gh<_i34.OpenWeatherUseCase>()));
  gh.factory<_i83.PlaceInformationBloc>(
      () => _i83.PlaceInformationBloc(gh<_i39.PlaceInformationUsecase>()));
  gh.factory<_i84.TeamDetailBloc>(
      () => _i84.TeamDetailBloc(gh<_i60.CommunityUsecase>()));
  gh.factory<_i85.UpgradePDoneBloc>(() => _i85.UpgradePDoneBloc(
        gh<_i47.UpgradeAccountUsecase>(),
        gh<_i51.UserUsecase>(),
      ));
  gh.factory<_i86.UserActionCubit>(
      () => _i86.UserActionCubit(gh<_i51.UserUsecase>()));
  ...
  gh.singleton<_i89.AppSettingBloc>(
      _i89.AppSettingBloc(gh<_i55.AuthenticationUsecase>()));
  gh.factory<_i90.AuthCubit>(
      () => _i90.AuthCubit(gh<_i55.AuthenticationUsecase>()));
  return getIt;
}
...
class _$CommunityModule extends _i93.CommunityModule {}
