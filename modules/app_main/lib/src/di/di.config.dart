...
import 'package:mobilehub_bloc/mobilehub_bloc.dart' as _i84;
import 'package:shared_preferences/shared_preferences.dart' as _i21;
import 'package:wallet/core/core.dart' as _i25;
import 'package:wallet/di/wallet_micro.module.dart' as _i121;

import '../app_delegate.dart' as _i4;
import '../blocs/app/app_cubit.dart' as _i118;
import '../blocs/auth/auth_cubit.dart' as _i120;
import '../blocs/community/team_request/team_request_cubit.dart' as _i112;
import '../blocs/marshop/marshop_cubit.dart' as _i104;
import '../blocs/user/user_cubit.dart' as _i116;
import '../blocs/user_action/user_action_cubit.dart' as _i114;
...
import '../data/data_sources/remote/chat_api.dart' as _i70;
import '../data/data_sources/remote/community_api.dart' as _i73;
...
import '../data/models/responses/boss_team_relinquish_status_response.dart'
    as _i94;
import '../data/models/responses/confirm_register_ja_response.dart' as _i91;
import '../data/models/responses/confirm_response.dart' as _i95;
import '../data/models/responses/group_request_response.dart' as _i98;
import '../data/models/responses/ja_status_response.dart' as _i87;
import '../data/models/responses/upgrade_account_response.dart' as _i85;
import '../data/repositories/auth_repository.dart' as _i66;
import '../data/repositories/impl/auth_repository_impl.dart' as _i67;
import '../data/repositories/impl/chat_repository_impl.dart' as _i72;
import '../data/repositories/impl/community_repository.impl.dart' as _i75;
...
import '../domain/entities/update_account/bank_acount/bank_account.dart'
    as _i86;
import '../domain/repository/chat_repository.dart' as _i71;
import '../domain/repository/community_repository.dart' as _i74;
...
import '../domain/usecases/community_usecase.dart' as _i76;
...
import '../presentation/community/community_constants.dart' as _i96;
import '../presentation/community/community_module.dart' as _i124;
...
import '../presentation/community/team_detail/pages/add_team_member_sheet.dart'
    as _i64;
import '../presentation/dashboard/dashboard/dashboard_screen.dart' as _i78;
...
import '../presentation/dashboard/dashboard/widget/dashboard_background_builder.dart'
    as _i77;
import '../presentation/dashboard/dashboard_module.dart' as _i127;
...
import '../presentation/notification/state/notification_bloc.dart' as _i105;
import '../presentation/otp_verify/email_otp_verify.dart' as _i82;
import '../presentation/profile/state/user_profile_bloc.dart' as _i117;
...
import '../presentation/shared/app_setting/bloc/app_setting_bloc.dart' as _i119;
import '../presentation/shared/user/bloc/user_bloc.dart' as _i115;
import '../presentation/social/profile/profile_bloc.dart' as _i126;
...
import '../presentation/upgrade_account/upgrade_pdone/bloc/upgrade_pdone/upgrade_pdone_bloc.dart'
    as _i113;
import 'modules/config_module.dart' as _i123;
...
Future<_i1.GetIt> init(
  ...
  gh.factory<_i70.ChatApi>(() => _i70.ChatApi(gh<_i30.Dio>()));
  gh.factory<_i71.ChatRepository>(
      () => _i72.ChatRepositoryImpl(gh<_i70.ChatApi>()));
  gh.factory<_i73.CommunityApi>(() => _i73.CommunityApi(gh<_i3.Dio>()));
  gh.factory<_i74.CommunityRepository>(
      () => _i75.CommunityRepositoryImpl(gh<_i73.CommunityApi>()));
  gh.factory<_i76.CommunityUsecase>(() => _i76.CommunityUsecase(
        gh<_i74.CommunityRepository>(),
        gh<_i54.ResourceUsecase>(),
      ));
  gh.factory<_i77.DashBoardBgController>(() =>
      _i77.DashBoardBgController(gh<_i26.DashboardSharePreferenceUseCase>()));
  gh.lazySingleton<_i78.DashBoardScreenController>(() =>
      _i78.DashBoardScreenController(
          gh<_i26.DashboardSharePreferenceUseCase>()));
  gh.factory<_i79.DashboardCommunityBloc>(() =>
      _i79.DashboardCommunityBloc(gh<_i26.DashboardSharePreferenceUseCase>()));
  gh.factory<_i79.DashboardEcommerceBloc>(() =>
      _i79.DashboardEcommerceBloc(gh<_i26.DashboardSharePreferenceUseCase>()));
  gh.factory<_i79.DashboardPersonalBloc>(() =>
      _i79.DashboardPersonalBloc(gh<_i26.DashboardSharePreferenceUseCase>()));
  gh.factoryParam<_i80.EditCommunityDetailBloc, _i3.Community, dynamic>((
    community,
    _,
  ) =>
      _i80.EditCommunityDetailBloc(
        gh<_i76.CommunityUsecase>(),
        community,
      ));
  gh.factoryParam<_i81.EditFanGroupBloc, _i3.FanGroup, dynamic>((
    fanGroup,
    _,
  ) =>
      _i81.EditFanGroupBloc(
        gh<_i76.CommunityUsecase>(),
        fanGroup,
      ));
  gh.factory<_i82.EmailVerifyController>(
      () => _i82.EmailVerifyController(gh<_i63.UserUsecase>()));
  gh.factory<_i83.FanGroupDetailBloc>(
      () => _i83.FanGroupDetailBloc(gh<_i76.CommunityUsecase>()));
  gh.factory<_i84.GetDetailBloc<_i3.FanGroup>>(
      () => communityModule.createGetFanGroupBloc(gh<_i76.CommunityUsecase>()));
  gh.factory<_i84.GetDetailBloc<_i85.UpgradeAccountResponse>>(() =>
      upgradeAgreePolicyBlocFactory
          .createUpgradeAccountBloc(gh<_i58.UpgradeAccountUsecase>()));
  gh.factory<_i84.GetDetailBloc<_i86.BankAccount>>(() =>
      upgradeAgreePolicyBlocFactory
          .createGetDefaultBankBloc(gh<_i58.UpgradeAccountUsecase>()));
  gh.factory<_i84.GetDetailBloc<_i87.JAStatusResponse>>(() =>
      upgradeAgreePolicyBlocFactory
          .createGetJAStatusBloc(gh<_i58.UpgradeAccountUsecase>()));
  gh.factory<
      _i84.GetDetailBlocParam1<_i86.BankAccount,
          _i88.UpdateBankAccountPayload>>(() => upgradeAgreePolicyBlocFactory
      .createUpdateBankAccountBloc(gh<_i58.UpgradeAccountUsecase>()));
  gh.factory<
      _i84.GetDetailBlocParam1<_i85.UpgradeAccountResponse,
          _i89.PDoneActionType>>(() => upgradeAgreePolicyBlocFactory
      .createResendOTPPhoneBloc(gh<_i58.UpgradeAccountUsecase>()));
  gh.factory<_i84.GetDetailBlocParam1<dynamic, _i90.VerifyPhoneOtpPayload>>(
      () => upgradeAgreePolicyBlocFactory.createUpgradeAccountVerifyPhoneBloc(
          gh<_i58.UpgradeAccountUsecase>()));
  gh.factory<_i84.GetDetailBlocParam1<_i3.User?, int>>(
      () => diaryBlocFactory.getUserDetailBloc(gh<_i63.UserUsecase>()));
  gh.factory<
      _i84.GetDetailBlocParam1<_i91.ConfirmRegisterJAResponse,
          _i92.ConfirmRegisterJAPayload>>(() => upgradeAgreePolicyBlocFactory
      .createConfirmRegisterJABloc(gh<_i58.UpgradeAccountUsecase>()));
  gh.factory<
          _i84.GetDetailBlocParam1<_i93.BossCommunityStatusResponse, String>>(
      () =>
          communityModule.createGetBossStatusBloc(gh<_i76.CommunityUsecase>()));
  gh.factory<
          _i84
          .GetDetailBlocParam1<_i94.BossTeamRelinquishStatusResponse, String>>(
      () => communityModule
          .createGetBossTeamRelinquishStatusBloc(gh<_i76.CommunityUsecase>()));
  gh.factory<
      _i84.GetDetailBlocParam2<_i95.ConfirmResponse, String,
          _i96.CommunityType>>(() => communityModule
      .createRelinquishBossRoleBloc(gh<_i76.CommunityUsecase>()));
  gh.factory<
      _i84.GetDetailBlocParam2<_i95.ConfirmResponse, String,
          _i97.ReplyGiveUpBossTeamRolePayload>>(() => communityModule
      .createReplyGiveUpBossTeamBloc(gh<_i76.CommunityUsecase>()));
  gh.factory<_i84.GetListBloc<_i98.GroupRequest>>(() =>
      communityModule.createGetGroupRequestsBloc(gh<_i76.CommunityUsecase>()));
  gh.factory<_i84.GetListBloc<_i3.Group>>(() =>
      communityModule.createGetListGroupsBloc(gh<_i76.CommunityUsecase>()));
  gh.factory<_i84.GetListBloc<_i3.Team>>(
      () => dashBoardModule.getMyTeams(gh<_i76.CommunityUsecase>()));
  gh.factory<_i84.GetListBloc<_i99.Bank>>(() => upgradeAgreePolicyBlocFactory
      .createGetListBanksBloc(gh<_i58.UpgradeAccountUsecase>()));
  gh.factory<_i84.GetListBlocParam1<_i3.Team, String>>(() =>
      communityModule.createGetListTeamsBloc(gh<_i76.CommunityUsecase>()));
  gh.factory<_i100.GroupDetailBloc>(
      () => _i100.GroupDetailBloc(gh<_i76.CommunityUsecase>()));
  gh.factory<_i101.GuardianPDoneBloc>(
      () => _i101.GuardianPDoneBloc(gh<_i58.UpgradeAccountUsecase>()));
  gh.factory<_i102.InformationUpdateProfilBloc>(
      () => _i102.InformationUpdateProfilBloc(
            gh<_i63.UserUsecase>(),
            gh<_i27.InformationPDoneSharePreferencesUsecase>(),
          ));
  gh.factory<_i103.ListProtectorRequestController>(
      () => _i103.ListProtectorRequestController(gh<_i50.ProtectorUseCase>()));
  gh.factory<_i103.ManageProtectController>(
      () => _i103.ManageProtectController(gh<_i50.ProtectorUseCase>()));
  gh.factory<_i104.MarshopCubit>(
      () => _i104.MarshopCubit(gh<_i33.MarshopUsecase>()));
  gh.factory<_i105.NotificationBloc>(
      () => _i105.NotificationBloc(gh<_i37.NotificationUsecase>()));
  gh.factory<_i106.OpenWeatherBloc>(
      () => _i106.OpenWeatherBloc(gh<_i41.OpenWeatherUseCase>()));
  gh.factory<_i107.PDoneInformationBloc>(
      () => _i107.PDoneInformationBloc(gh<_i58.UpgradeAccountUsecase>()));
  gh.factory<_i108.PlaceInformationBloc>(
      () => _i108.PlaceInformationBloc(gh<_i46.PlaceInformationUsecase>()));
  gh.factory<_i109.PlaceInformationBloc2>(
      () => _i109.PlaceInformationBloc2(gh<_i46.PlaceInformationUsecase>()));
  gh.factory<_i110.SearchCubit>(
      () => _i110.SearchCubit(gh<_i63.UserUsecase>()));
  gh.factory<_i111.TeamDetailBloc>(
      () => _i111.TeamDetailBloc(gh<_i76.CommunityUsecase>()));
  gh.factory<_i112.TeamRequestCubit>(
      () => _i112.TeamRequestCubit(gh<_i76.CommunityUsecase>()));
  gh.factory<_i113.UpgradePDoneBloc>(() => _i113.UpgradePDoneBloc(
        gh<_i58.UpgradeAccountUsecase>(),
        gh<_i63.UserUsecase>(),
        gh<_i24.UserSharePreferencesUsecase>(),
      ));
  gh.factory<_i114.UserActionCubit>(
      () => _i114.UserActionCubit(gh<_i63.UserUsecase>()));
  gh.factory<_i115.UserBloc>(() => _i115.UserBloc(
        gh<_i68.AuthenticationUsecase>(),
        gh<_i24.UserSharePreferencesUsecase>(),
        gh<_i63.UserUsecase>(),
        gh<_i3.UserInformationCubit>(),
      ));
  gh.factory<_i116.UserCubit>(() => _i116.UserCubit(
        gh<_i68.AuthenticationUsecase>(),
        gh<_i24.UserSharePreferencesUsecase>(),
        gh<_i63.UserUsecase>(),
      ));
  gh.factory<_i117.UserProfileBloc>(() => _i117.UserProfileBloc(
        gh<_i63.UserUsecase>(),
        gh<_i50.ProtectorUseCase>(),
        gh<_i13.MediaPicker>(),
        gh<_i58.UpgradeAccountUsecase>(),
      ));
  gh.factory<_i118.AppCubit>(() => _i118.AppCubit(
        gh<_i54.ResourceUsecase>(),
        gh<_i24.UserSharePreferencesUsecase>(),
        gh<_i68.AuthenticationUsecase>(),
      ));
  gh.singleton<_i119.AppSettingBloc>(
      _i119.AppSettingBloc(gh<_i68.AuthenticationUsecase>()));
  gh.factory<_i120.AuthCubit>(
      () => _i120.AuthCubit(gh<_i68.AuthenticationUsecase>()));
  await _i121.WalletPackageModule().init(gh);
  return getIt;
}

class _$DataSourceModule extends _i122.DataSourceModule {}

class _$ConfigModule extends _i123.ConfigModule {}

class _$PlaceModule extends _i43.PlaceModule {}

class _$CommunityModule extends _i124.CommunityModule {}

class _$UpgradeAgreePolicyBlocFactory
    extends _i125.UpgradeAgreePolicyBlocFactory {}

class _$DiaryBlocFactory extends _i126.DiaryBlocFactory {}

class _$DashBoardModule extends _i127.DashBoardModule {}
