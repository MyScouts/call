...
import '../blocs/app/app_cubit.dart' as _i124;
import '../blocs/auth/auth_cubit.dart' as _i126;
import '../blocs/community/team_request/team_request_cubit.dart' as _i118;
import '../blocs/marshop/marshop_cubit.dart' as _i110;
import '../blocs/user/user_cubit.dart' as _i122;
import '../blocs/user_action/user_action_cubit.dart' as _i120;
...
import '../data/models/responses/boss_team_relinquish_status_response.dart'
    as _i98;
import '../data/models/responses/confirm_register_ja_response.dart' as _i93;
...
import '../data/models/responses/ja_status_response.dart' as _i90;
...
import '../presentation/dashboard/dashboard/widget/dashboard_background_builder.dart'
    as _i83;
import '../presentation/dashboard/dashboard_module.dart' as _i131;
...
import '../presentation/notification/state/notification_bloc.dart' as _i111;
import '../presentation/profile/state/user_profile_bloc.dart' as _i123;
...
import '../presentation/shared/app_setting/bloc/app_setting_bloc.dart' as _i125;
import '../presentation/shared/user/bloc/user_bloc.dart' as _i121;
import '../presentation/social/profile/profile_bloc.dart' as _i130;
...
Future<_i1.GetIt> init(
  ...
  gh.factory<_i34.LiveChannelController>(() => _i34.LiveChannelController(
        gh<_i13.LiveService>(),
  ...
  gh.factory<_i78.ChangePasswordController>(
      () => _i78.ChangePasswordController(gh<_i77.AuthenticationUsecase>()));
  ...
  gh.factory<_i89.GetDetailBloc<_i90.JAStatusResponse>>(() =>
  ...
  gh.factory<
      _i89.GetDetailBlocParam1<_i93.ConfirmRegisterJAResponse,
          _i94.ConfirmRegisterJAPayload>>(() => upgradeAgreePolicyBlocFactory
  ...
  gh.factory<_i106.GuardianPDoneBloc>(
      () => _i106.GuardianPDoneBloc(gh<_i67.UpgradeAccountUsecase>()));
  ...
  gh.factory<_i108.ListProtectorRequestController>(
      () => _i108.ListProtectorRequestController(gh<_i59.ProtectorUseCase>()));
  gh.factory<_i109.LiveController>(
      () => _i109.LiveController(gh<_i37.LiveUseCase>()));
  gh.factory<_i108.ManageProtectController>(
      () => _i108.ManageProtectController(gh<_i59.ProtectorUseCase>()));
  gh.factory<_i110.MarshopCubit>(
      () => _i110.MarshopCubit(gh<_i42.MarshopUsecase>()));
  gh.factory<_i111.NotificationBloc>(
      () => _i111.NotificationBloc(gh<_i46.NotificationUsecase>()));
  gh.factory<_i112.OpenWeatherBloc>(
      () => _i112.OpenWeatherBloc(gh<_i50.OpenWeatherUseCase>()));
  gh.factory<_i113.PDoneInformationBloc>(
      () => _i113.PDoneInformationBloc(gh<_i67.UpgradeAccountUsecase>()));
  gh.factory<_i114.PlaceInformationBloc>(
      () => _i114.PlaceInformationBloc(gh<_i55.PlaceInformationUsecase>()));
  gh.factory<_i115.PlaceInformationBloc2>(
      () => _i115.PlaceInformationBloc2(gh<_i55.PlaceInformationUsecase>()));
  gh.factory<_i116.SearchCubit>(
      () => _i116.SearchCubit(gh<_i72.UserUsecase>()));
  gh.factory<_i117.TeamDetailBloc>(
      () => _i117.TeamDetailBloc(gh<_i82.CommunityUsecase>()));
  gh.factory<_i118.TeamRequestCubit>(
      () => _i118.TeamRequestCubit(gh<_i82.CommunityUsecase>()));
  gh.factory<_i119.UpgradePDoneBloc>(() => _i119.UpgradePDoneBloc(
        gh<_i67.UpgradeAccountUsecase>(),
        gh<_i72.UserUsecase>(),
        gh<_i29.UserSharePreferencesUsecase>(),
      ));
  gh.factory<_i120.UserActionCubit>(
      () => _i120.UserActionCubit(gh<_i72.UserUsecase>()));
  gh.factory<_i121.UserBloc>(() => _i121.UserBloc(
        gh<_i77.AuthenticationUsecase>(),
        gh<_i29.UserSharePreferencesUsecase>(),
        gh<_i72.UserUsecase>(),
        gh<_i3.UserInformationCubit>(),
      ));
  gh.factory<_i122.UserCubit>(() => _i122.UserCubit(
        gh<_i77.AuthenticationUsecase>(),
        gh<_i29.UserSharePreferencesUsecase>(),
        gh<_i72.UserUsecase>(),
      ));
  ...
  gh.factory<_i124.AppCubit>(() => _i124.AppCubit(
        gh<_i63.ResourceUsecase>(),
        gh<_i29.UserSharePreferencesUsecase>(),
        gh<_i77.AuthenticationUsecase>(),
      ));
  gh.singleton<_i125.AppSettingBloc>(
      _i125.AppSettingBloc(gh<_i77.AuthenticationUsecase>()));
  gh.factory<_i126.AuthCubit>(
      () => _i126.AuthCubit(gh<_i77.AuthenticationUsecase>()));
  return getIt;
}
...
class _$UpgradeAgreePolicyBlocFactory
    extends _i128.UpgradeAgreePolicyBlocFactory {}

class _$CommunityModule extends _i129.CommunityModule {}

class _$DiaryBlocFactory extends _i130.DiaryBlocFactory {}

class _$DashBoardModule extends _i131.DashBoardModule {}
