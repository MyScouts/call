...
import 'package:wallet/di/wallet_micro.module.dart' as _i193;

import '../app_delegate.dart' as _i4;
import '../blocs/app/app_cubit.dart' as _i187;
import '../blocs/approved_request/approved_request_cubit.dart' as _i107;
import '../blocs/auth/auth_cubit.dart' as _i189;
import '../blocs/bloc.dart' as _i199;
import '../blocs/community/team_request/team_request_cubit.dart' as _i181;
import '../blocs/marshop/marshop_cubit.dart' as _i169;
import '../blocs/user/user_cubit.dart' as _i185;
import '../blocs/user_action/user_action_cubit.dart' as _i183;
...
import '../data/models/payloads/community/reply_give_up_boss_team_role_payload.dart'
    as _i155;
import '../data/models/payloads/marshop/marshop_payload.dart' as _i151;
...
import '../data/models/payloads/upgrade_account/upgrade_ja/verify_phone_otp.dart'
    as _i148;
import '../data/models/responses/boss_community_status_response.dart' as _i143;
import '../data/models/responses/boss_team_relinquish_status_response.dart'
    as _i149;
import '../data/models/responses/confirm_register_ja_response.dart' as _i144;
import '../data/models/responses/confirm_response.dart' as _i153;
...
import '../data/models/responses/ja_status_response.dart' as _i139;
import '../data/models/responses/marshop_response.dart' as _i150;
import '../data/models/responses/open_group_request_response.dart' as _i142;
import '../data/models/responses/resource_response.dart' as _i152;
import '../data/models/responses/upgrade_account_response.dart' as _i140;
...
import '../domain/entities/bank.dart' as _i157;
import '../domain/entities/commity_action_type.dart' as _i147;
...
import '../domain/usecases/post_usecase.dart' as _i178;
...
import '../presentation/chat/chat_room/cubit/chat_room_cubit.dart' as _i191;
import '../presentation/chat/chat_routes.dart' as _i9;
import '../presentation/chat/conversation/cubit/conversation_cubit.dart'
    as _i130;
import '../presentation/chat/create_room/cubit/create_room_cubit.dart' as _i131;
import '../presentation/chat/new_message/cubit/new_message_cubit.dart' as _i171;
import '../presentation/community/community_constants.dart' as _i154;
import '../presentation/community/community_module.dart' as _i198;
...
import '../presentation/community/team_detail/pages/add_team_member_sheet.dart'
    as _i105;
import '../presentation/dashboard/dashboard/dashboard_screen.dart' as _i133;
...
import '../presentation/dashboard/dashboard/widget/dashboard_background_builder.dart'
    as _i132;
import '../presentation/dashboard/dashboard_module.dart' as _i201;
...
import '../presentation/live/presentation/widget/mashop_status_builder.dart'
    as _i168;
import '../presentation/marshop/marshop_bloc.dart' as _i196;
...
import '../presentation/notification/state/notification_bloc.dart' as _i172;
import '../presentation/otp_verify/email_otp_verify.dart' as _i136;
import '../presentation/profile/state/user_profile_bloc.dart' as _i186;
...
import '../presentation/shared/app_setting/bloc/app_setting_bloc.dart' as _i188;
import '../presentation/shared/user/bloc/user_bloc.dart' as _i184;
import '../presentation/social/following/blocs/following_bloc.dart' as _i137;
...
import '../presentation/social/my_profile/blocs/my_profile_bloc.dart' as _i170;
import '../presentation/social/my_profile/blocs/post_tab_bloc.dart' as _i192;
...
import '../presentation/social/my_profile/screens/components/create_post/blocs/create_post_bloc.dart'
    as _i41;
import '../presentation/social/profile/profile_bloc.dart' as _i200;
...
import '../presentation/upgrade_account/upgrade_pdone/bloc/upgrade_pdone/upgrade_pdone_bloc.dart'
    as _i182;
import 'modules/config_module.dart' as _i195;
import 'modules/data_source_module.dart' as _i194;
...
Future<_i1.GetIt> init(
  ...
  gh.singleton<_i130.ConversationCubit>(
      _i130.ConversationCubit(gh<_i121.ChatUseCase>()));
  gh.factory<_i131.CreateRoomCubit>(
      () => _i131.CreateRoomCubit(gh<_i121.ChatUseCase>()));
  gh.factory<_i132.DashBoardBgController>(() =>
      _i132.DashBoardBgController(gh<_i42.DashboardSharePreferenceUseCase>()));
  gh.lazySingleton<_i133.DashBoardScreenController>(() =>
      _i133.DashBoardScreenController(
          gh<_i42.DashboardSharePreferenceUseCase>()));
  gh.factory<_i134.DashboardCommunityBloc>(() =>
      _i134.DashboardCommunityBloc(gh<_i42.DashboardSharePreferenceUseCase>()));
  gh.factory<_i134.DashboardEcommerceBloc>(() =>
      _i134.DashboardEcommerceBloc(gh<_i42.DashboardSharePreferenceUseCase>()));
  gh.factory<_i134.DashboardPersonalBloc>(() =>
      _i134.DashboardPersonalBloc(gh<_i42.DashboardSharePreferenceUseCase>()));
  gh.factoryParam<_i135.EditCommunityDetailBloc, _i3.Community, dynamic>((
    community,
    _,
  ) =>
      _i135.EditCommunityDetailBloc(
        gh<_i129.CommunityUsecase>(),
        gh<_i94.ResourceUsecase>(),
        community,
      ));
  gh.factory<_i136.EmailVerifyController>(
      () => _i136.EmailVerifyController(gh<_i104.UserUsecase>()));
  gh.factory<_i137.FollowingBloc>(
      () => _i137.FollowingBloc(gh<_i104.UserUsecase>()));
  gh.factory<_i138.FollowingTabBloc>(() => _i138.FollowingTabBloc(
        gh<_i51.FollowingUsecase>(),
        gh<_i104.UserUsecase>(),
      ));
  gh.factory<_i56.GetDetailBloc<_i139.JAStatusResponse>>(() =>
      upgradeAgreePolicyBlocFactory
          .createGetJAStatusBloc(gh<_i99.UpgradeAccountUsecase>()));
  gh.factory<_i56.GetDetailBloc<_i140.UpgradeAccountResponse>>(() =>
      upgradeAgreePolicyBlocFactory
  ...
  gh.factory<_i56.GetDetailBloc<_i142.OpenGroupRequestResponse>>(() =>
      communityModule
  ...
  gh.factory<
          _i56.GetDetailBlocParam1<_i143.BossCommunityStatusResponse, String>>(
      () => communityModule
  ...
  gh.factory<
      _i56.GetDetailBlocParam1<_i144.ConfirmRegisterJAResponse,
          _i145.ConfirmRegisterJAPayload>>(() => upgradeAgreePolicyBlocFactory
  ...
  gh.factory<
      _i56.GetDetailBlocParam1<_i141.BankAccount,
          _i146.UpdateBankAccountPayload>>(() => upgradeAgreePolicyBlocFactory
      .createUpdateBankAccountBloc(gh<_i99.UpgradeAccountUsecase>()));
  gh.factory<
      _i56.GetDetailBlocParam1<_i140.UpgradeAccountResponse,
          _i147.PDoneActionType>>(() => upgradeAgreePolicyBlocFactory
      .createResendOTPPhoneBloc(gh<_i99.UpgradeAccountUsecase>()));
  gh.factory<_i56.GetDetailBlocParam1<dynamic, _i148.VerifyPhoneOtpPayload>>(
      () => upgradeAgreePolicyBlocFactory.createUpgradeAccountVerifyPhoneBloc(
          gh<_i99.UpgradeAccountUsecase>()));
  gh.factory<
          _i56
          .GetDetailBlocParam1<_i149.BossTeamRelinquishStatusResponse, String>>(
      () => communityModule
          .createGetBossTeamRelinquishStatusBloc(gh<_i129.CommunityUsecase>()));
  gh.factory<
          _i56.GetDetailBlocParam1<_i150.MarshopResponse,
              _i151.GetMarshopInfoPayload>>(
      () => marshopBlocFactory.getMarshopInfo(gh<_i69.MarshopUsecase>()));
  gh.factory<_i56.GetDetailBlocParam1<_i152.GlobalSettingResponse, String>>(
      () => blocModule.getGlobalBloc(gh<_i94.ResourceUsecase>()));
  gh.factory<
      _i56.GetDetailBlocParam2<_i153.ConfirmResponse, String,
          _i154.CommunityType>>(() => communityModule
      .createRelinquishBossRoleBloc(gh<_i129.CommunityUsecase>()));
  gh.factory<
      _i56.GetDetailBlocParam2<_i153.ConfirmResponse, String,
          _i155.ReplyGiveUpBossTeamRolePayload>>(() => communityModule
  ...
  gh.factory<_i56.GetListBloc<_i150.MarshopRegisterPackResponse>>(
  ...
  gh.factory<_i56.GetListBloc<_i157.Bank>>(() => upgradeAgreePolicyBlocFactory
  ...
  gh.factory<
          _i56.GetListBlocParam1<_i150.MarshopResponse,
              _i151.GetListMarshopPayload>>(
      () => marshopBlocFactory.listMarshopBloc(gh<_i69.MarshopUsecase>()));
  gh.factory<_i158.GiftController>(
      () => _i158.GiftController(gh<_i65.LiveUseCase>()));
  gh.factory<_i159.GroupDetailBloc>(
      () => _i159.GroupDetailBloc(gh<_i129.CommunityUsecase>()));
  gh.factory<_i160.GuardianPDoneBloc>(
      () => _i160.GuardianPDoneBloc(gh<_i99.UpgradeAccountUsecase>()));
  gh.factory<_i161.InformationUpdateProfilBloc>(
      () => _i161.InformationUpdateProfilBloc(
            gh<_i104.UserUsecase>(),
            gh<_i59.InformationPDoneSharePreferencesUsecase>(),
          ));
  gh.factory<_i162.ListProtectorRequestController>(
      () => _i162.ListProtectorRequestController(gh<_i90.ProtectorUseCase>()));
  gh.factory<_i163.LiveBottomController>(() => _i163.LiveBottomController(
        gh<_i65.LiveUseCase>(),
        gh<_i104.UserUsecase>(),
      ));
  gh.factory<_i164.LiveChannelController>(() => _i164.LiveChannelController(
  ...
  gh.factory<_i165.LiveCheckPasswordController>(
      () => _i165.LiveCheckPasswordController(gh<_i65.LiveUseCase>()));
  gh.factory<_i166.LiveController>(
      () => _i166.LiveController(gh<_i65.LiveUseCase>()));
  gh.factory<_i167.LiveCreateController>(() => _i167.LiveCreateController(
        gh<_i62.LiveRepository>(),
        gh<_i21.LiveService>(),
      ));
  gh.factory<_i162.ManageProtectController>(
      () => _i162.ManageProtectController(gh<_i90.ProtectorUseCase>()));
  gh.factory<_i168.MarShopBuilderController>(
      () => _i168.MarShopBuilderController(gh<_i104.UserUsecase>()));
  gh.factory<_i169.MarshopCubit>(
      () => _i169.MarshopCubit(gh<_i69.MarshopUsecase>()));
  gh.factory<_i170.MyProfileBloc>(
      () => _i170.MyProfileBloc(gh<_i104.UserUsecase>()));
  gh.factory<_i171.NewMessageCubit>(
      () => _i171.NewMessageCubit(gh<_i121.ChatUseCase>()));
  gh.factory<_i172.NotificationBloc>(
      () => _i172.NotificationBloc(gh<_i73.NotificationUsecase>()));
  gh.factory<_i173.OpenWeatherBloc>(
      () => _i173.OpenWeatherBloc(gh<_i77.OpenWeatherUseCase>()));
  gh.factory<_i174.PDoneInformationBloc>(
      () => _i174.PDoneInformationBloc(gh<_i99.UpgradeAccountUsecase>()));
  gh.factory<_i175.PhoneBookDetailCubit>(
      () => _i175.PhoneBookDetailCubit(gh<_i115.CallUseCase>()));
  gh.factory<_i176.PlaceInformationBloc>(
      () => _i176.PlaceInformationBloc(gh<_i83.PlaceInformationUsecase>()));
  gh.factory<_i177.PlaceInformationBloc2>(
      () => _i177.PlaceInformationBloc2(gh<_i83.PlaceInformationUsecase>()));
  gh.factory<_i178.PostUsecase>(() => _i178.PostUsecase(
        gh<_i85.PostRepository>(),
        gh<_i125.CommentUsecase>(),
        gh<_i91.ResourceApi>(),
      ));
  gh.factory<_i179.SearchCubit>(
      () => _i179.SearchCubit(gh<_i104.UserUsecase>()));
  gh.factory<_i180.TeamDetailBloc>(
      () => _i180.TeamDetailBloc(gh<_i129.CommunityUsecase>()));
  gh.factory<_i181.TeamRequestCubit>(
      () => _i181.TeamRequestCubit(gh<_i129.CommunityUsecase>()));
  gh.factory<_i182.UpgradePDoneBloc>(() => _i182.UpgradePDoneBloc(
        gh<_i99.UpgradeAccountUsecase>(),
        gh<_i104.UserUsecase>(),
        gh<_i39.UserSharePreferencesUsecase>(),
      ));
  gh.factory<_i183.UserActionCubit>(
      () => _i183.UserActionCubit(gh<_i104.UserUsecase>()));
  gh.factory<_i184.UserBloc>(() => _i184.UserBloc(
        gh<_i111.AuthenticationUsecase>(),
        gh<_i39.UserSharePreferencesUsecase>(),
        gh<_i104.UserUsecase>(),
        gh<_i3.UserInformationCubit>(),
      ));
  gh.factory<_i185.UserCubit>(() => _i185.UserCubit(
        gh<_i111.AuthenticationUsecase>(),
        gh<_i39.UserSharePreferencesUsecase>(),
        gh<_i104.UserUsecase>(),
      ));
  ...
  gh.factory<_i187.AppCubit>(() => _i187.AppCubit(
        gh<_i94.ResourceUsecase>(),
        gh<_i39.UserSharePreferencesUsecase>(),
        gh<_i111.AuthenticationUsecase>(),
      ));
  gh.singleton<_i188.AppSettingBloc>(
      _i188.AppSettingBloc(gh<_i111.AuthenticationUsecase>()));
  gh.factory<_i189.AuthCubit>(
      () => _i189.AuthCubit(gh<_i111.AuthenticationUsecase>()));
  gh.factory<_i190.CallHistoryCubit>(
      () => _i190.CallHistoryCubit(gh<_i115.CallUseCase>()));
  gh.singleton<_i191.ChatRoomCubit>(_i191.ChatRoomCubit(
    gh<_i121.ChatUseCase>(),
    gh<_i104.UserUsecase>(),
    gh<_i99.UpgradeAccountUsecase>(),
    gh<_i26.MediaPicker>(),
  ));
  gh.factory<_i192.PostTabBloc>(() => _i192.PostTabBloc(
        gh<_i104.UserUsecase>(),
        gh<_i178.PostUsecase>(),
        gh<_i125.CommentUsecase>(),
        gh<_i104.UserUsecase>(),
      ));
  await _i193.WalletPackageModule().init(gh);
  return getIt;
}

class _$DataSourceModule extends _i194.DataSourceModule {}

class _$ConfigModule extends _i195.ConfigModule {}

class _$MarshopBlocFactory extends _i196.MarshopBlocFactory {}

class _$PlaceModule extends _i80.PlaceModule {}

class _$UpgradeAgreePolicyBlocFactory
    extends _i197.UpgradeAgreePolicyBlocFactory {}

class _$CommunityModule extends _i198.CommunityModule {}

class _$BlocModule extends _i199.BlocModule {}

class _$DiaryBlocFactory extends _i200.DiaryBlocFactory {}

class _$DashBoardModule extends _i201.DashBoardModule {}
