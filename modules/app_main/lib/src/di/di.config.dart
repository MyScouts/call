...
import '../blocs/auth/auth_cubit.dart' as _i68;
import '../blocs/marshop/marshop_cubit.dart' as _i63;
import '../blocs/user/user_cubit.dart' as _i66;
...
import '../domain/entities/bank.dart' as _i62;
...
import '../domain/usecases/dashboard_share_preferences_usecase.dart' as _i18;
...
import '../presentation/shared/app_setting/bloc/app_setting_bloc.dart' as _i67;
import '../presentation/shared/user/bloc/user_bloc.dart' as _i65;
...
Future<_i1.GetIt> init(
  ...
  gh.factory<_i18.DashboardSharePreferenceUseCase>(
      () => _i18.DashboardSharePreferenceUseCase(gh<_i15.SharedPreferences>()));
  gh.factory<_i3.Dio>(
  ...
  gh.factory<_i55.DashboardCommunityBloc>(() =>
      _i55.DashboardCommunityBloc(gh<_i18.DashboardSharePreferenceUseCase>()));
  gh.factory<_i55.DashboardEcommerceBloc>(() =>
      _i55.DashboardEcommerceBloc(gh<_i18.DashboardSharePreferenceUseCase>()));
  gh.factory<_i55.DashboardPersonalBloc>(() =>
      _i55.DashboardPersonalBloc(gh<_i18.DashboardSharePreferenceUseCase>()));
  ...
  gh.factory<_i56.GetDetailBlocParam1<bool, _i58.VerifyPhoneOtpPayload>>(() =>
  ...
  gh.factory<
      _i56.GetDetailBlocParam1<_i60.BankAccount,
          _i61.UpdateBankAccountPayload>>(() => upgradeAgreePolicyBlocFactory
      .createUpdateBankAccountBloc(gh<_i41.UpgradeAccountUsecase>()));
  gh.factory<_i56.GetListBloc<_i62.Bank>>(() => upgradeAgreePolicyBlocFactory
  ...
  gh.factory<_i63.MarshopCubit>(
      () => _i63.MarshopCubit(gh<_i24.MarshopUsecase>()));
  gh.factory<_i64.PlaceInformationBloc>(
      () => _i64.PlaceInformationBloc(gh<_i33.PlaceInformationUsecase>()));
  ...
  gh.factory<_i66.UserCubit>(() => _i66.UserCubit(
        gh<_i50.AuthenticationUsecase>(),
        gh<_i17.UserSharePreferencesUsecase>(),
        gh<_i46.UserUsecase>(),
      ));
  gh.singleton<_i67.AppSettingBloc>(
      _i67.AppSettingBloc(gh<_i50.AuthenticationUsecase>()));
  gh.factory<_i68.AuthCubit>(
      () => _i68.AuthCubit(gh<_i50.AuthenticationUsecase>()));
  return getIt;
}
...
class _$UpgradeAgreePolicyBlocFactory
    extends _i70.UpgradeAgreePolicyBlocFactory {}
