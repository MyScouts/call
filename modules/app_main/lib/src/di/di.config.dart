...
import 'package:mobilehub_bloc/mobilehub_bloc.dart' as _i75;
import 'package:shared_preferences/shared_preferences.dart' as _i19;

import '../app_delegate.dart' as _i4;
import '../blocs/auth/auth_cubit.dart' as _i109;
import '../blocs/community/team_request/team_request_cubit.dart' as _i103;
import '../blocs/marshop/marshop_cubit.dart' as _i95;
import '../blocs/user/user_cubit.dart' as _i107;
import '../blocs/user_action/user_action_cubit.dart' as _i105;
...
import '../data/data_sources/local/information_pdone_profile/information_pdone_profile_local.dart'
    as _i24;
import '../data/data_sources/remote/auth_api.dart' as _i61;
import '../data/data_sources/remote/community_api.dart' as _i66;
...
import '../data/data_sources/remote/user_api.dart' as _i56;
...
import '../data/models/payloads/upgrade_account/upgrade_ja/update_bank_account_payload.dart'
    as _i83;
>>>>>>> f30da2e171807cb2d33401c205512b037948c49a
import '../data/models/payloads/upgrade_account/upgrade_ja/verify_phone_otp.dart'
    as _i83;
import '../data/models/responses/boss_community_status_response.dart' as _i82;
import '../data/models/responses/boss_team_relinquish_status_response.dart'
<<<<<<< HEAD
    as _i81;
import '../data/models/responses/confirm_register_ja_response.dart' as _i79;
=======
    as _i82;
import '../data/models/responses/confirm_register_ja_response.dart' as _i84;
>>>>>>> f30da2e171807cb2d33401c205512b037948c49a
import '../data/models/responses/confirm_response.dart' as _i86;
import '../data/models/responses/group_request_response.dart' as _i89;
import '../data/models/responses/ja_status_response.dart' as _i77;
import '../data/models/responses/upgrade_account_response.dart' as _i76;
import '../data/repositories/auth_repository.dart' as _i62;
import '../data/repositories/impl/auth_repository_impl.dart' as _i63;
import '../data/repositories/impl/community_repository.impl.dart' as _i68;
...
import '../data/repositories/impl/user_repository_impl.dart' as _i58;
...
import '../data/repositories/user_repository.dart' as _i57;
import '../domain/entities/bank.dart' as _i90;
...
import '../domain/entities/update_account/bank_acount/bank_account.dart'
    as _i78;
import '../domain/repository/community_repository.dart' as _i67;
...
import '../domain/usecases/authentication_usecase.dart' as _i64;
import '../domain/usecases/community_usecase.dart' as _i69;
...
import '../domain/usecases/user_usecase.dart' as _i59;
import '../presentation/authentication/authentication_routes.dart' as _i5;
import '../presentation/community/community_constants.dart' as _i87;
import '../presentation/community/community_module.dart' as _i112;
...
import '../presentation/dashboard/dashboard/widget/dashboard_background_builder.dart'
    as _i70;
import '../presentation/dashboard/dashboard_module.dart' as _i114;
...
import '../presentation/notification/state/notification_bloc.dart' as _i96;
...
import '../presentation/shared/app_setting/bloc/app_setting_bloc.dart' as _i108;
import '../presentation/shared/user/bloc/user_bloc.dart' as _i106;
import '../presentation/social/profile/profile_bloc.dart' as _i113;
...
import '../presentation/upgrade_account/upgrade_pdone/bloc/upgrade_pdone/upgrade_pdone_bloc.dart'
    as _i104;
import 'modules/data_source_module.dart' as _i110;
...
Future<_i1.GetIt> init(
  ...
  gh.factory<_i56.UserApi>(() => _i56.UserApi(gh<_i3.Dio>()));
  gh.factory<_i57.UserRepository>(
      () => _i58.AuthRepositoryImpl(gh<_i56.UserApi>()));
  gh.factory<_i59.UserUsecase>(
      () => _i59.UserUsecase(gh<_i57.UserRepository>()));
  gh.factory<_i60.AddMemberChangeNotifier>(
      () => _i60.AddMemberChangeNotifier(gh<_i59.UserUsecase>()));
  gh.factory<_i61.AuthApi>(() => _i61.AuthApi(gh<_i27.Dio>()));
  gh.factory<_i62.AuthRepository>(
      () => _i63.AuthRepositoryImpl(gh<_i61.AuthApi>()));
  gh.factory<_i64.AuthenticationUsecase>(() => _i64.AuthenticationUsecase(
  ...
  gh.factory<_i65.ChangePasswordController>(
      () => _i65.ChangePasswordController(gh<_i64.AuthenticationUsecase>()));
  gh.factory<_i66.CommunityApi>(() => _i66.CommunityApi(gh<_i3.Dio>()));
  gh.factory<_i67.CommunityRepository>(
      () => _i68.CommunityRepositoryImpl(gh<_i66.CommunityApi>()));
  gh.factory<_i69.CommunityUsecase>(() => _i69.CommunityUsecase(
        gh<_i67.CommunityRepository>(),
        gh<_i51.ResourceUsecase>(),
      ));
  gh.factory<_i70.DashBoardBgController>(() =>
      _i70.DashBoardBgController(gh<_i23.DashboardSharePreferenceUseCase>()));
  gh.factory<_i71.DashboardCommunityBloc>(() =>
      _i71.DashboardCommunityBloc(gh<_i23.DashboardSharePreferenceUseCase>()));
  gh.factory<_i71.DashboardEcommerceBloc>(() =>
      _i71.DashboardEcommerceBloc(gh<_i23.DashboardSharePreferenceUseCase>()));
  gh.factory<_i71.DashboardPersonalBloc>(() =>
      _i71.DashboardPersonalBloc(gh<_i23.DashboardSharePreferenceUseCase>()));
  gh.factoryParam<_i72.EditCommunityDetailBloc, _i3.Community, dynamic>((
    community,
    _,
  ) =>
      _i72.EditCommunityDetailBloc(
        gh<_i69.CommunityUsecase>(),
        community,
      ));
  gh.factoryParam<_i73.EditFanGroupBloc, _i3.FanGroup, dynamic>((
    fanGroup,
    _,
  ) =>
      _i73.EditFanGroupBloc(
        gh<_i69.CommunityUsecase>(),
        fanGroup,
      ));
  gh.factory<_i74.FanGroupDetailBloc>(
      () => _i74.FanGroupDetailBloc(gh<_i69.CommunityUsecase>()));
  gh.factory<_i75.GetDetailBloc<_i3.FanGroup>>(
      () => communityModule.createGetFanGroupBloc(gh<_i69.CommunityUsecase>()));
  gh.factory<_i75.GetDetailBloc<_i76.UpgradeAccountResponse>>(() =>
      upgradeAgreePolicyBlocFactory
          .createUpgradeAccountBloc(gh<_i55.UpgradeAccountUsecase>()));
<<<<<<< HEAD
  gh.factory<_i75.GetDetailBloc<_i3.FanGroup>>(
      () => communityModule.createGetFanGroupBloc(gh<_i69.CommunityUsecase>()));
  gh.factory<_i75.GetDetailBloc<_i77.JAStatusResponse>>(() =>
=======
  gh.factory<_i75.GetDetailBloc<_i77.BankAccount>>(() =>
      upgradeAgreePolicyBlocFactory
          .createGetDefaultBankBloc(gh<_i55.UpgradeAccountUsecase>()));
  gh.factory<_i75.GetDetailBloc<_i78.JAStatusResponse>>(() =>
>>>>>>> f30da2e171807cb2d33401c205512b037948c49a
      upgradeAgreePolicyBlocFactory
          .createGetJAStatusBloc(gh<_i55.UpgradeAccountUsecase>()));
  gh.factory<_i75.GetDetailBloc<_i78.BankAccount>>(() =>
      upgradeAgreePolicyBlocFactory
          .createGetDefaultBankBloc(gh<_i55.UpgradeAccountUsecase>()));
  gh.factory<
      _i75.GetDetailBlocParam1<_i79.ConfirmRegisterJAResponse,
          _i80.ConfirmRegisterJAPayload>>(() => upgradeAgreePolicyBlocFactory
  ...
  gh.factory<
      ...
      () => communityModule
          .createGetBossTeamRelinquishStatusBloc(gh<_i69.CommunityUsecase>()));
  gh.factory<
          _i75.GetDetailBlocParam1<_i82.BossCommunityStatusResponse, String>>(
      () =>
          communityModule.createGetBossStatusBloc(gh<_i69.CommunityUsecase>()));
  gh.factory<_i75.GetDetailBlocParam1<dynamic, _i83.VerifyPhoneOtpPayload>>(
      () => upgradeAgreePolicyBlocFactory.createUpgradeAccountVerifyPhoneBloc(
          gh<_i55.UpgradeAccountUsecase>()));
  gh.factory<_i75.GetDetailBlocParam1<_i3.User?, int>>(
      () => diaryBlocFactory.getUserDetailBloc(gh<_i59.UserUsecase>()));
  gh.factory<
<<<<<<< HEAD
      _i75.GetDetailBlocParam1<_i78.BankAccount,
          _i84.UpdateBankAccountPayload>>(() => upgradeAgreePolicyBlocFactory
      .createUpdateBankAccountBloc(gh<_i55.UpgradeAccountUsecase>()));
  gh.factory<_i75.GetDetailBlocParam1<_i3.User?, int>>(
      () => diaryBlocFactory.getUserDetailBloc(gh<_i59.UserUsecase>()));
=======
          _i75.GetDetailBlocParam1<_i80.BossCommunityStatusResponse, String>>(
      () =>
          communityModule.createGetBossStatusBloc(gh<_i69.CommunityUsecase>()));
>>>>>>> f30da2e171807cb2d33401c205512b037948c49a
  gh.factory<
      _i75.GetDetailBlocParam1<_i76.UpgradeAccountResponse,
          _i85.PDoneActionType>>(() => upgradeAgreePolicyBlocFactory
      .createResendOTPPhoneBloc(gh<_i55.UpgradeAccountUsecase>()));
  gh.factory<
<<<<<<< HEAD
      _i75.GetDetailBlocParam2<_i86.ConfirmResponse, String,
          _i87.ReplyGiveUpBossTeamRolePayload>>(() => communityModule
      .createReplyGiveUpBossTeamBloc(gh<_i69.CommunityUsecase>()));
=======
          _i75
      ...
      () => communityModule
          .createGetBossTeamRelinquishStatusBloc(gh<_i69.CommunityUsecase>()));
  gh.factory<
      _i75.GetDetailBlocParam1<_i77.BankAccount,
          _i83.UpdateBankAccountPayload>>(() => upgradeAgreePolicyBlocFactory
      .createUpdateBankAccountBloc(gh<_i55.UpgradeAccountUsecase>()));
  gh.factory<
      _i75.GetDetailBlocParam1<_i84.ConfirmRegisterJAResponse,
          _i85.ConfirmRegisterJAPayload>>(() => upgradeAgreePolicyBlocFactory
      .createConfirmRegisterJABloc(gh<_i55.UpgradeAccountUsecase>()));
>>>>>>> f30da2e171807cb2d33401c205512b037948c49a
  gh.factory<
      _i75.GetDetailBlocParam2<_i86.ConfirmResponse, String,
          _i87.CommunityType>>(() => communityModule
      .createRelinquishBossRoleBloc(gh<_i69.CommunityUsecase>()));
<<<<<<< HEAD
  gh.factory<_i75.GetListBloc<_i89.GroupRequest>>(() =>
      communityModule.createGetGroupRequestsBloc(gh<_i69.CommunityUsecase>()));
  gh.factory<_i75.GetListBloc<_i3.Team>>(
      () => dashBoardModule.getMyTeams(gh<_i69.CommunityUsecase>()));
  gh.factory<_i75.GetListBloc<_i90.Bank>>(() => upgradeAgreePolicyBlocFactory
=======
  gh.factory<
      _i75.GetDetailBlocParam2<_i86.ConfirmResponse, String,
          _i88.ReplyGiveUpBossTeamRolePayload>>(() => communityModule
      .createReplyGiveUpBossTeamBloc(gh<_i69.CommunityUsecase>()));
  gh.factory<_i75.GetListBloc<_i89.Bank>>(() => upgradeAgreePolicyBlocFactory
>>>>>>> f30da2e171807cb2d33401c205512b037948c49a
      .createGetListBanksBloc(gh<_i55.UpgradeAccountUsecase>()));
  gh.factory<_i75.GetListBloc<_i3.Group>>(() =>
      communityModule.createGetListGroupsBloc(gh<_i69.CommunityUsecase>()));
  gh.factory<_i75.GetListBloc<_i90.GroupRequest>>(() =>
      communityModule.createGetGroupRequestsBloc(gh<_i69.CommunityUsecase>()));
  gh.factory<_i75.GetListBlocParam1<_i3.Team, String>>(() =>
      communityModule.createGetListTeamsBloc(gh<_i69.CommunityUsecase>()));
  gh.factory<_i91.GroupDetailBloc>(
      () => _i91.GroupDetailBloc(gh<_i69.CommunityUsecase>()));
  gh.factory<_i92.GuardianPDoneBloc>(
      () => _i92.GuardianPDoneBloc(gh<_i55.UpgradeAccountUsecase>()));
  gh.factory<_i93.InformationUpdateProfilBloc>(
      () => _i93.InformationUpdateProfilBloc(
            gh<_i59.UserUsecase>(),
            gh<_i24.InformationPDoneSharePreferencesUsecase>(),
          ));
  gh.factory<_i94.ListProtectorRequestController>(
      () => _i94.ListProtectorRequestController(gh<_i47.ProtectorUseCase>()));
  gh.factory<_i94.ManageProtectController>(
      () => _i94.ManageProtectController(gh<_i47.ProtectorUseCase>()));
  gh.factory<_i95.MarshopCubit>(
      () => _i95.MarshopCubit(gh<_i30.MarshopUsecase>()));
  gh.factory<_i96.NotificationBloc>(
      () => _i96.NotificationBloc(gh<_i34.NotificationUsecase>()));
  gh.factory<_i97.OpenWeatherBloc>(
      () => _i97.OpenWeatherBloc(gh<_i38.OpenWeatherUseCase>()));
  gh.factory<_i98.PDoneInformationBloc>(
      () => _i98.PDoneInformationBloc(gh<_i55.UpgradeAccountUsecase>()));
  gh.factory<_i99.PlaceInformationBloc>(
      () => _i99.PlaceInformationBloc(gh<_i43.PlaceInformationUsecase>()));
  gh.factory<_i100.PlaceInformationBloc2>(
      () => _i100.PlaceInformationBloc2(gh<_i43.PlaceInformationUsecase>()));
  gh.factory<_i101.SearchCubit>(
      () => _i101.SearchCubit(gh<_i59.UserUsecase>()));
  gh.factory<_i102.TeamDetailBloc>(
      () => _i102.TeamDetailBloc(gh<_i69.CommunityUsecase>()));
  gh.factory<_i103.TeamRequestCubit>(
      () => _i103.TeamRequestCubit(gh<_i69.CommunityUsecase>()));
  gh.factory<_i104.UpgradePDoneBloc>(() => _i104.UpgradePDoneBloc(
        gh<_i55.UpgradeAccountUsecase>(),
        gh<_i59.UserUsecase>(),
        gh<_i22.UserSharePreferencesUsecase>(),
      ));
  gh.factory<_i105.UserActionCubit>(
      () => _i105.UserActionCubit(gh<_i59.UserUsecase>()));
  gh.factory<_i106.UserBloc>(() => _i106.UserBloc(
        gh<_i64.AuthenticationUsecase>(),
        gh<_i22.UserSharePreferencesUsecase>(),
        gh<_i59.UserUsecase>(),
        gh<_i3.UserInformationCubit>(),
      ));
  gh.factory<_i107.UserCubit>(() => _i107.UserCubit(
        gh<_i64.AuthenticationUsecase>(),
        gh<_i22.UserSharePreferencesUsecase>(),
        gh<_i59.UserUsecase>(),
      ));
  gh.singleton<_i108.AppSettingBloc>(
      _i108.AppSettingBloc(gh<_i64.AuthenticationUsecase>()));
  gh.factory<_i109.AuthCubit>(
      () => _i109.AuthCubit(gh<_i64.AuthenticationUsecase>()));
  return getIt;
}

class _$DataSourceModule extends _i110.DataSourceModule {}

class _$PlaceModule extends _i40.PlaceModule {}

class _$UpgradeAgreePolicyBlocFactory
    extends _i111.UpgradeAgreePolicyBlocFactory {}

class _$CommunityModule extends _i112.CommunityModule {}

class _$DiaryBlocFactory extends _i113.DiaryBlocFactory {}

class _$DashBoardModule extends _i114.DashBoardModule {}
