...
import '../blocs/auth/auth_cubit.dart' as _i99;
import '../blocs/community/team_request/team_request_cubit.dart' as _i93;
import '../blocs/marshop/marshop_cubit.dart' as _i86;
import '../blocs/user/user_cubit.dart' as _i97;
import '../blocs/user_action/user_action_cubit.dart' as _i95;
...
import '../presentation/community/community_module.dart' as _i102;
...
import '../presentation/notification/state/notification_bloc.dart' as _i87;
...
import '../presentation/shared/app_setting/bloc/app_setting_bloc.dart' as _i98;
import '../presentation/shared/user/bloc/user_bloc.dart' as _i96;
import '../presentation/social/profile/profile_bloc.dart' as _i103;
...
import '../presentation/upgrade_account/upgrade_pdone/bloc/upgrade_pdone/upgrade_pdone_bloc.dart'
    as _i94;
import 'modules/data_source_module.dart' as _i100;
...
Future<_i1.GetIt> init(
  ...
  gh.factory<_i67.GetDetailBloc<_i69.UpgradeAccountResponse>>(() =>
      upgradeAgreePolicyBlocFactory
  ...
  gh.factory<
      _i67.GetDetailBlocParam1<_i69.UpgradeAccountResponse,
  ...
  gh.factory<_i84.GuardianPDoneBloc>(
      () => _i84.GuardianPDoneBloc(gh<_i48.UpgradeAccountUsecase>()));
  gh.factory<_i85.InformationUpdateProfilBloc>(
      () => _i85.InformationUpdateProfilBloc(gh<_i52.UserUsecase>()));
  gh.factory<_i86.MarshopCubit>(
      () => _i86.MarshopCubit(gh<_i27.MarshopUsecase>()));
  gh.factory<_i87.NotificationBloc>(
      () => _i87.NotificationBloc(gh<_i31.NotificationUsecase>()));
  gh.factory<_i88.OpenWeatherBloc>(
      () => _i88.OpenWeatherBloc(gh<_i35.OpenWeatherUseCase>()));
  gh.factory<_i89.PlaceInformationBloc>(
      () => _i89.PlaceInformationBloc(gh<_i40.PlaceInformationUsecase>()));
  gh.factory<_i90.PlaceInformationBloc2>(
      () => _i90.PlaceInformationBloc2(gh<_i40.PlaceInformationUsecase>()));
  gh.factory<_i91.SearchCubit>(() => _i91.SearchCubit(gh<_i52.UserUsecase>()));
  gh.factory<_i92.TeamDetailBloc>(
      () => _i92.TeamDetailBloc(gh<_i61.CommunityUsecase>()));
  gh.factory<_i93.TeamRequestCubit>(
      () => _i93.TeamRequestCubit(gh<_i61.CommunityUsecase>()));
  gh.factory<_i94.UpgradePDoneBloc>(() => _i94.UpgradePDoneBloc(
        gh<_i48.UpgradeAccountUsecase>(),
        gh<_i52.UserUsecase>(),
      ));
  gh.factory<_i95.UserActionCubit>(
      () => _i95.UserActionCubit(gh<_i52.UserUsecase>()));
  gh.factory<_i96.UserBloc>(() => _i96.UserBloc(
        gh<_i56.AuthenticationUsecase>(),
        gh<_i21.UserSharePreferencesUsecase>(),
        gh<_i52.UserUsecase>(),
        gh<_i3.UserInformationCubit>(),
      ));
  gh.factory<_i97.UserCubit>(() => _i97.UserCubit(
        gh<_i56.AuthenticationUsecase>(),
        gh<_i21.UserSharePreferencesUsecase>(),
        gh<_i52.UserUsecase>(),
      ));
  gh.singleton<_i98.AppSettingBloc>(
      _i98.AppSettingBloc(gh<_i56.AuthenticationUsecase>()));
  gh.factory<_i99.AuthCubit>(
      () => _i99.AuthCubit(gh<_i56.AuthenticationUsecase>()));
  return getIt;
}

class _$DataSourceModule extends _i100.DataSourceModule {}

class _$PlaceModule extends _i37.PlaceModule {}

class _$UpgradeAgreePolicyBlocFactory
    extends _i101.UpgradeAgreePolicyBlocFactory {}

class _$CommunityModule extends _i102.CommunityModule {}

class _$DiaryBlocFactory extends _i103.DiaryBlocFactory {}
