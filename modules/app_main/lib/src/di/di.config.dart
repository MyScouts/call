...
import '../blocs/auth/auth_cubit.dart' as _i98;
import '../blocs/community/team_request/team_request_cubit.dart' as _i92;
import '../blocs/marshop/marshop_cubit.dart' as _i85;
import '../blocs/user/user_cubit.dart' as _i96;
import '../blocs/user_action/user_action_cubit.dart' as _i94;
...
import '../data/models/responses/boss_team_relinquish_status_response.dart'
    as _i71;
import '../data/models/responses/confirm_register_ja_response.dart' as _i75;
import '../data/models/responses/confirm_response.dart' as _i78;
import '../data/models/responses/group_request_response.dart' as _i81;
import '../data/models/responses/ja_status_response.dart' as _i70;
import '../data/models/responses/upgrade_account_response.dart' as _i68;
...
import '../domain/entities/bank.dart' as _i82;
...
import '../presentation/community/community_constants.dart' as _i80;
import '../presentation/community/community_module.dart' as _i101;
...
import '../presentation/notification/state/notification_bloc.dart' as _i86;
...
import '../presentation/shared/app_setting/bloc/app_setting_bloc.dart' as _i97;
import '../presentation/shared/user/bloc/user_bloc.dart' as _i95;
import '../presentation/social/profile/profile_bloc.dart' as _i102;
...
import '../presentation/upgrade_account/upgrade_pdone/bloc/upgrade_pdone/upgrade_pdone_bloc.dart'
    as _i93;
import 'modules/data_source_module.dart' as _i99;
...
Future<_i1.GetIt> init(
  ...
  gh.factory<_i45.UpgradeAccountRepository>(
      () => _i46.UpgradeAccountRepositoryImpl(
            gh<_i44.UpgradeAccountApi>(),
            gh<_i40.ResourceApi>(),
          ));
  ...
  gh.factory<_i52.AddMemberChangeNotifier>(
      () => _i52.AddMemberChangeNotifier(gh<_i51.UserUsecase>()));
  gh.factory<_i53.AuthApi>(() => _i53.AuthApi(gh<_i23.Dio>()));
  ...
  gh.factory<_i62.DashBoardBgController>(() =>
      _i62.DashBoardBgController(gh<_i21.DashboardSharePreferenceUseCase>()));
  gh.factory<_i63.DashboardCommunityBloc>(() =>
      _i63.DashboardCommunityBloc(gh<_i21.DashboardSharePreferenceUseCase>()));
  gh.factory<_i63.DashboardEcommerceBloc>(() =>
      _i63.DashboardEcommerceBloc(gh<_i21.DashboardSharePreferenceUseCase>()));
  gh.factory<_i63.DashboardPersonalBloc>(() =>
      _i63.DashboardPersonalBloc(gh<_i21.DashboardSharePreferenceUseCase>()));
  ...
  gh.factory<_i67.GetDetailBloc<_i68.UpgradeAccountResponse>>(() =>
      upgradeAgreePolicyBlocFactory
          .createUpgradeAccountBloc(gh<_i47.UpgradeAccountUsecase>()));
  gh.factory<_i67.GetDetailBloc<_i69.BankAccount>>(() =>
      upgradeAgreePolicyBlocFactory
  ...
  gh.factory<_i67.GetDetailBloc<_i70.JAStatusResponse>>(() =>
      upgradeAgreePolicyBlocFactory
          .createGetJAStatusBloc(gh<_i47.UpgradeAccountUsecase>()));
  gh.factory<
          _i67
          .GetDetailBlocParam1<_i71.BossTeamRelinquishStatusResponse, String>>(
      () => communityModule
          .createGetBossTeamRelinquishStatusBloc(gh<_i61.CommunityUsecase>()));
  gh.factory<_i67.GetDetailBlocParam1<bool, _i72.VerifyPhoneOtpPayload>>(() =>
      upgradeAgreePolicyBlocFactory.createUpgradeAccountVerifyPhoneBloc(
          gh<_i47.UpgradeAccountUsecase>()));
  gh.factory<
      _i67.GetDetailBlocParam1<_i68.UpgradeAccountResponse,
          _i73.PDoneActionType>>(() => upgradeAgreePolicyBlocFactory
      .createResendOTPPhoneBloc(gh<_i47.UpgradeAccountUsecase>()));
  gh.factory<
      _i67.GetDetailBlocParam1<_i69.BankAccount,
          _i74.UpdateBankAccountPayload>>(() => upgradeAgreePolicyBlocFactory
      .createUpdateBankAccountBloc(gh<_i47.UpgradeAccountUsecase>()));
  gh.factory<
      _i67.GetDetailBlocParam1<_i75.ConfirmRegisterJAResponse,
          _i76.ConfirmRegisterJAPayload>>(() => upgradeAgreePolicyBlocFactory
      .createConfirmRegisterJABloc(gh<_i47.UpgradeAccountUsecase>()));
  gh.factory<
          _i67.GetDetailBlocParam1<_i77.BossCommunityStatusResponse, String>>(
      () =>
  ...
  gh.factory<_i83.GroupDetailBloc>(
      () => _i83.GroupDetailBloc(gh<_i61.CommunityUsecase>()));
  gh.factory<_i84.GuardianPDoneBloc>(
      () => _i84.GuardianPDoneBloc(gh<_i47.UpgradeAccountUsecase>()));
  gh.factory<_i85.MarshopCubit>(
      () => _i85.MarshopCubit(gh<_i26.MarshopUsecase>()));
  gh.factory<_i86.NotificationBloc>(
      () => _i86.NotificationBloc(gh<_i30.NotificationUsecase>()));
  gh.factory<_i87.OpenWeatherBloc>(
      () => _i87.OpenWeatherBloc(gh<_i34.OpenWeatherUseCase>()));
  gh.factory<_i88.PDoneInformationBloc>(
      () => _i88.PDoneInformationBloc(gh<_i47.UpgradeAccountUsecase>()));
  gh.factory<_i89.PlaceInformationBloc>(
      () => _i89.PlaceInformationBloc(gh<_i39.PlaceInformationUsecase>()));
  gh.factory<_i90.SearchCubit>(() => _i90.SearchCubit(gh<_i51.UserUsecase>()));
  gh.factory<_i91.TeamDetailBloc>(
      () => _i91.TeamDetailBloc(gh<_i61.CommunityUsecase>()));
  gh.factory<_i92.TeamRequestCubit>(
      () => _i92.TeamRequestCubit(gh<_i61.CommunityUsecase>()));
  gh.factory<_i93.UpgradePDoneBloc>(() => _i93.UpgradePDoneBloc(
        gh<_i47.UpgradeAccountUsecase>(),
        gh<_i51.UserUsecase>(),
      ));
  gh.factory<_i94.UserActionCubit>(
      () => _i94.UserActionCubit(gh<_i51.UserUsecase>()));
  gh.factory<_i95.UserBloc>(() => _i95.UserBloc(
        gh<_i56.AuthenticationUsecase>(),
        gh<_i20.UserSharePreferencesUsecase>(),
        gh<_i51.UserUsecase>(),
        gh<_i3.UserInformationCubit>(),
      ));
  gh.factory<_i96.UserCubit>(() => _i96.UserCubit(
        gh<_i56.AuthenticationUsecase>(),
        gh<_i20.UserSharePreferencesUsecase>(),
        gh<_i51.UserUsecase>(),
      ));
  gh.singleton<_i97.AppSettingBloc>(
      _i97.AppSettingBloc(gh<_i56.AuthenticationUsecase>()));
  gh.factory<_i98.AuthCubit>(
      () => _i98.AuthCubit(gh<_i56.AuthenticationUsecase>()));
  return getIt;
}

class _$DataSourceModule extends _i99.DataSourceModule {}

class _$PlaceModule extends _i36.PlaceModule {}

class _$UpgradeAgreePolicyBlocFactory
    extends _i100.UpgradeAgreePolicyBlocFactory {}

class _$CommunityModule extends _i101.CommunityModule {}

class _$DiaryBlocFactory extends _i102.DiaryBlocFactory {}
