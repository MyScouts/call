...
import 'package:wallet/di/wallet_micro.module.dart' as _i186;

import '../app_delegate.dart' as _i4;
import '../blocs/app/app_cubit.dart' as _i180;
import '../blocs/approved_request/approved_request_cubit.dart' as _i101;
import '../blocs/auth/auth_cubit.dart' as _i182;
...
import '../data/models/responses/boss_team_relinquish_status_response.dart'
    as _i141;
import '../data/models/responses/confirm_register_ja_response.dart' as _i142;
...
import '../data/models/responses/ja_status_response.dart' as _i133;
import '../data/models/responses/marshop_response.dart' as _i137;
import '../data/models/responses/upgrade_account_response.dart' as _i135;
...
import '../domain/entities/commity_action_type.dart' as _i140;
...
import '../presentation/chat/add_member/cubit/add_member_cubit.dart' as _i178;
import '../presentation/chat/chat_room/cubit/chat_room_cubit.dart' as _i184;
...
import '../presentation/community/community_module.dart' as _i191;
...
import '../presentation/dashboard/dashboard/widget/dashboard_background_builder.dart'
    as _i126;
import '../presentation/dashboard/dashboard_module.dart' as _i193;
...
import '../presentation/live/presentation/widget/check_password_enable.dart'
    as _i157;
import '../presentation/marshop/marshop_bloc.dart' as _i189;
...
import '../presentation/shared/app_setting/bloc/app_setting_bloc.dart' as _i181;
import '../presentation/shared/user/bloc/user_bloc.dart' as _i175;
import '../presentation/social/my_profile/blocs/my_profile_bloc.dart' as _i185;
...
import '../presentation/social/my_profile/screens/components/create_post/blocs/create_post_bloc.dart'
    as _i40;
import '../presentation/social/profile/profile_bloc.dart' as _i192;
...
import '../presentation/upgrade_account/upgrade_pdone/bloc/upgrade_pdone/upgrade_pdone_bloc.dart'
    as _i173;
import 'modules/config_module.dart' as _i188;
import 'modules/data_source_module.dart' as _i187;
...
Future<_i1.GetIt> init(
  ...
  gh.factory<_i51.GetDetailBloc<_i133.JAStatusResponse>>(() =>
  ...
  gh.factory<_i51.GetDetailBloc<_i135.UpgradeAccountResponse>>(() =>
      upgradeAgreePolicyBlocFactory
          .createUpgradeAccountBloc(gh<_i93.UpgradeAccountUsecase>()));
  gh.factory<_i51.GetDetailBlocParam1<dynamic, _i136.VerifyPhoneOtpPayload>>(
  ...
  gh.factory<
      _i51.GetDetailBlocParam1<_i135.UpgradeAccountResponse,
          _i140.PDoneActionType>>(() => upgradeAgreePolicyBlocFactory
      .createResendOTPPhoneBloc(gh<_i93.UpgradeAccountUsecase>()));
  gh.factory<
          _i51
          .GetDetailBlocParam1<_i141.BossTeamRelinquishStatusResponse, String>>(
      () => communityModule
          .createGetBossTeamRelinquishStatusBloc(gh<_i123.CommunityUsecase>()));
  gh.factory<
      _i51.GetDetailBlocParam1<_i142.ConfirmRegisterJAResponse,
          _i143.ConfirmRegisterJAPayload>>(() => upgradeAgreePolicyBlocFactory
  ...
  gh.singleton<_i161.MemberTabCubit>(_i161.MemberTabCubit(
  ...
  gh.factory<_i178.AddMemberCubit>(
      () => _i178.AddMemberCubit(gh<_i115.ChatUseCase>()));
  gh.factory<_i179.AdminTabCubit>(
      () => _i179.AdminTabCubit(gh<_i115.ChatUseCase>()));
  gh.factory<_i180.AppCubit>(() => _i180.AppCubit(
        gh<_i88.ResourceUsecase>(),
        gh<_i38.UserSharePreferencesUsecase>(),
        gh<_i105.AuthenticationUsecase>(),
      ));
  gh.singleton<_i181.AppSettingBloc>(
      _i181.AppSettingBloc(gh<_i105.AuthenticationUsecase>()));
  gh.factory<_i182.AuthCubit>(
      () => _i182.AuthCubit(gh<_i105.AuthenticationUsecase>()));
  gh.factory<_i183.CallHistoryCubit>(
      () => _i183.CallHistoryCubit(gh<_i109.CallUseCase>()));
  gh.singleton<_i184.ChatRoomCubit>(_i184.ChatRoomCubit(
    gh<_i115.ChatUseCase>(),
    gh<_i98.UserUsecase>(),
    gh<_i93.UpgradeAccountUsecase>(),
    gh<_i25.MediaPicker>(),
  ));
  gh.factory<_i185.MyProfileBloc>(() => _i185.MyProfileBloc(
        gh<_i98.UserUsecase>(),
        gh<_i169.PostUsecase>(),
        gh<_i119.CommentUsecase>(),
        gh<_i98.UserUsecase>(),
      ));
  await _i186.WalletPackageModule().init(gh);
  return getIt;
}

class _$DataSourceModule extends _i187.DataSourceModule {}

class _$ConfigModule extends _i188.ConfigModule {}

class _$MarshopBlocFactory extends _i189.MarshopBlocFactory {}

class _$PlaceModule extends _i74.PlaceModule {}

class _$UpgradeAgreePolicyBlocFactory
    extends _i190.UpgradeAgreePolicyBlocFactory {}

class _$CommunityModule extends _i191.CommunityModule {}

class _$DiaryBlocFactory extends _i192.DiaryBlocFactory {}

class _$DashBoardModule extends _i193.DashBoardModule {}
