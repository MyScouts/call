...
extension PlayerStateExt on PlayerState {
  bool get stopped => this == PlayerState.stopped;
  bool get playing => this == PlayerState.playing;
  bool get paused => this == PlayerState.paused;
  bool get completed => this == PlayerState.completed;
}
