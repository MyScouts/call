...
// in mobilehub_bloc/test/gen_mock/mock_object.dart.
...
import 'mock_object.dart' as _i10;
...
/// A class which mocks [ServiceGetList].
///
/// See the documentation for Mockito's code generation for more information.
class MockServiceGetList extends _i1.Mock implements _i10.ServiceGetList {
  MockServiceGetList() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i8.Future<List<String>> getListingString() => (super.noSuchMethod(
        Invocation.method(
          #getListingString,
          [],
        ),
  ...
  @override
  _i8.Future<List<String>> getListingStringParam1(int? param) =>
      (super.noSuchMethod(
        Invocation.method(
          #getListingStringParam1,
          [param],
        ),
        returnValue: _i8.Future<List<String>>.value(<String>[]),
      ) as _i8.Future<List<String>>);
