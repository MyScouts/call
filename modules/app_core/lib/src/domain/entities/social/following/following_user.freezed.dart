...
/// @nodoc
@JsonSerializable()
class _$FollowingUserImpl implements _FollowingUser {
  const _$FollowingUserImpl(
      {this.id,
      this.avatar,
      this.displayName,
      this.pDoneId,
  ...
  @override
  String toString() {
    return 'FollowingUser(id: $id, avatar: $avatar, displayName: $displayName, pDoneId: $pDoneId, fullName: $fullName, birthday: $birthday, sexCode: $sexCode, type: $type)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, id, avatar, displayName, pDoneId,
      fullName, birthday, sexCode, type);
...
abstract class _FollowingUser implements FollowingUser {
  const factory _FollowingUser(
      ...
      final String? birthday,
      final int? sexCode,
      final int? type}) = _$FollowingUserImpl;
