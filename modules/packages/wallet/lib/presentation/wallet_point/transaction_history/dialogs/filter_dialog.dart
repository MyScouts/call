...
class TransactionFilterDialog extends StatefulWidget {
  final PointTransactionHistoryFilter? defaultFilter;
...
class TransactionFilterDialogState extends State<TransactionFilterDialog> {
  late PointTransactionHistoryFilter transactionData;

  set setTransactionData(PointTransactionHistoryFilter value) =>
      transactionData = value;

  void handleTimeFilter(DateTime value) =>
      setTransactionData = transactionData.copyWith(date: value);

  void handleTypeFilter(List<PointTransactionHistoryType> value) {
  ...
  void initState() {
    transactionData =
        widget.defaultFilter ?? const PointTransactionHistoryFilter();
    super.initState();
  }
    ...
    return Column(
      ...
      children: [
        ...
        MultipleChoiceButton(
          ...
          titles:
              PointTransactionHistoryType.values.map((e) => e.title).toList(),
          values: PointTransactionHistoryType.values,
