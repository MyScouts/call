...
abstract class $BankCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {int? id, String? name, String? logo, String? shortName, String? code});
}
...
class _$BankImpl implements _Bank {
  const _$BankImpl({this.id, this.name, this.logo, this.shortName, this.code});
  ...
  @override
  String toString() {
    return 'Bank(id: $id, name: $name, logo: $logo, shortName: $shortName, code: $code)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, name, logo, shortName, code);
